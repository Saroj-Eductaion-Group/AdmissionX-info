    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
               <!-- <a href="{{ url('employee/placement') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> -->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('employee/users', $placement->eUserId) }}">{{ $placement->employeeFirstname }} {{ $placement->employeeMiddlename}} {{ $placement->employeeLastname}} (ID:- {{ $placement->eUserId}}) Date & Time:-  {{ $placement->updated_at}}</a>
                                @else
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('employee/users', $placement->collegeUserID) }}">{{ $placement->collegeUserFirstName }}</a>
                                 @else
                                    <span class="label label-warning">Not Updated Yet</span>
                                @endif
                            </td>
