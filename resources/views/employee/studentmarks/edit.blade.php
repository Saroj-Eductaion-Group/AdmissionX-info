...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Student Marks <!-- <a href="{{ url('employee/studentmarks') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($studentmark, [
                'method' => 'PATCH',
                'url' => ['employee/studentmarks', $studentmark->id],
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="marks" value="{{ $studentmark->marks }}" placeholder="Enter marks here" data-parsley-trigger="change" data-parsley-error-message="Please enter your marks" required="" data-parsley-type="digits" data-parsley-length="[2, 3]" data-parsley-minlength="1" data-parsley-maxlength="3" maxlength="3" data-parsley-max="900">
                </div>
            </div>
            <div class="form-group">
