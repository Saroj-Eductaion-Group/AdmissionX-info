...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Create New Student Marks <!-- <a href="{{ url('employee/studentmarks') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::open(['url' => 'employee/studentmarks', 'class' => 'form-horizontal','data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}

            <div class="form-group">
                <label class="col-sm-2 control-label" >Marks : </label>
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="marks" placeholder="Enter marks here" data-parsley-trigger="change" data-parsley-error-message="Please enter your marks" required="" data-parsley-type="digits" data-parsley-length="[2, 3]" data-parsley-minlength="1" data-parsley-maxlength="3" maxlength="3" data-parsley-max="100">
                </div>
            </div>
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="percentage" placeholder="Enter percentage here" data-parsley-trigger="change" data-parsley-error-message="Please enter your percentage" required="" data-parsley-type="digits" data-parsley-length="[2, 3]" data-parsley-minlength="1" data-parsley-maxlength="3" maxlength="3" data-parsley-max="100">
                </div>
            </div>
            <!-- <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="studentProfileName" class="form-control chosen-select " data-placeholder="Choose student profile..."  data-parsley-error-message=" Please select student profile" data-parsley-trigger="change" required="">
                        ...
                        @foreach ($studentProfile as $studentProfile)
                            <option value="{{ $studentProfile->id }}">{{ $studentProfile->id }} {{ $studentProfile->parentsname }}</option>
                        @endforeach    
                    </select>     
                </div>
            </div>
