...
<!-- <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>College Facilities Details <a href="{{ url('employee/collegefacilities/create') }}" class="btn btn-primary pull-right btn-sm">Add New College Facilities</a></h2>
    </div>
</div> -->
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-college-facility', 'class' => 'form-horizontal search-form search-form']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="row">  
                                        <div class="col-md-12 text-right">      
                                            <a href="{{ URL::to('employee/collegefacilities') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($collegefacilities as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/collegefacilities', $item->id) }}">{{ $item->id }}</a></td>
                                    <!-- <td>
                                        @if( $item->collegeFacilitiesName)
                                           <a href="{{ url('employee/collegefacilities', $item->id) }}">{{ $item->collegeFacilitiesName }}</a>
                                        @else
                                    ...
                                    <td>
                                        @if( $item->facilitiesName)
                                            <a href="{{ url('employee/collegefacilities', $item->id) }}">{{ $item->facilitiesName }}</a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/collegefacilities/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> <!-- /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/collegefacilities', $item->id],
...
@section('script')
{!! Html::script('assets/employee/js/moment.js') !!}
...
$(document).ready(function(){
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.collegeFacilitySearchDataObj, function (key, item) {
                                ...
                                if( data.collegeFacilitySearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.collegeFacilitySearchDataObj[key].eUserId +"/') !!}' >"+ data.collegeFacilitySearchDataObj[key].employeeFirstname+' '+data.collegeFacilitySearchDataObj[key].employeeMiddlename+' '+data.collegeFacilitySearchDataObj[key].employeeLastname+' (User Id:- '+data.collegeFacilitySearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.collegeFacilitySearchDataObj[key].updated_at +"</a>";
                                }
                               
                                 $("tbody").append("<tr><td><a href='{!! URL::to('employee/collegefacilities/"+ data.collegeFacilitySearchDataObj[key].collegefacilitiesId +"/') !!}' >"+ data.collegeFacilitySearchDataObj[key].collegefacilitiesId +"</a></td><td><a href='{!! URL::to('employee/collegeprofile/"+ data.collegeFacilitySearchDataObj[key].collegeprofileID +"/') !!}' >"+ usernameDataText + "</a></td><td><a href='{!! URL::to('employee/collegefacilities/"+ data.collegeFacilitySearchDataObj[key].collegefacilitiesId +"/') !!}' >"+ facilityDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/collegefacilities/"+ data.collegeFacilitySearchDataObj[key].collegefacilitiesId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-college-facility') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id </td><td class='searchFilter'>College Profile</td><td class='searchFilter'>Facilities</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].collegeFacilitiesName == '' ){
                                ...
                                if( data[key].eUserId == null ){
                                 ...
                                 $("tbody").append("<tr><td><a href='{!! URL::to('employee/collegefacilities/"+ data[key].collegefacilitiesId +"/') !!}' >"+ data[key].collegefacilitiesId +"</a></td><td><a href='{!! URL::to('employee/collegeprofile/"+ data[key].collegeprofileID +"/') !!}' >"+ usernameDataText + "</a></td><td><a href='{!! URL::to('employee/collegefacilities/"+ data[key].collegefacilitiesId +"/') !!}' >"+ facilityDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/collegefacilities/"+ data[key].collegefacilitiesId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-college-facility') }}",
