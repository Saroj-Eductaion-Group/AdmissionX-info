            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-logs', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">      
                                            <a href="{{ URL::to('employee/logs') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($logs as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/logs', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/logs', $item->id) }}">{{ $item->firstname }} {{ $item->lastname }} </a></td>
                                    <td>{{ $item->event }}</td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <!-- <td>
                                        <a href="{{ url('employee/logs/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> --><!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/logs', $item->id],
        ...
        $(document).ready(function() {
            ...
            $('.search-form').on('submit',function(e){
                ...
                $.ajax({
                    ...
                    success  : function(data) {
                        ...
                        $(".thead").empty();
                        $(".tbody").empty();
                        $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>User Name</td><td class='searchFilter'>Event Name</td><td class='searchFilter'>Last Updated By</td></tr>");
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.logsSearchDataObj, function (key, item) {
                                ...
                                if( data.logsSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.logsSearchDataObj[key].eUserId +"/') !!}' >"+ data.logsSearchDataObj[key].employeeFirstname+' '+data.logsSearchDataObj[key].employeeMiddlename+' '+data.logsSearchDataObj[key].employeeLastname+' (User Id:- '+data.logsSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.logsSearchDataObj[key].updated_at +"</a>";
                                }
                                
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/logs/"+ data.logsSearchDataObj[key].logId +"/') !!}' >"+ data.logsSearchDataObj[key].logId +"</a></td><td><a href='{!! URL::to('employee/user/"+ data.logsSearchDataObj[key].usersId +"/') !!}' >"+ userNameDataText +"</a></td><td><a href='{!! URL::to('employee/logs/"+ data.logsSearchDataObj[key].logId +"/') !!}' >"+ eventDataText +"</a></td><td>"+ lastUpdatedBy +" </td></tr>");
                                //<td><a href='{!! URL::to('employee/logs/"+ data.logsSearchDataObj[key].logId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td>
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-logs') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>User Name</td><td class='searchFilter'>Event Name</td><td class='searchFilter'>Last Updated By</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].eUserId == null ){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/logs/"+ data[key].logId +"/') !!}' >"+ data[key].logId +"</a></td><td><a href='{!! URL::to('employee/user/"+ data[key].usersId +"/') !!}' >"+ userNameDataText +"</a></td><td><a href='{!! URL::to('employee/logs/"+ data[key].logId +"/') !!}' >"+ eventDataText +"</a></td><td>"+ lastUpdatedBy +" </td></tr>");
                                //<td><a href='{!! URL::to('employee/logs/"+ data[key].logId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td>
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-logs') }}",
