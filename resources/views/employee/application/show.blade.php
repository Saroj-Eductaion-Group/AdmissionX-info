    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
               <!-- <a href="{{ url('employee/application') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> -->
               <div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('employee/users', $application->eUserId) }}">{{ $application->employeeFirstname }} {{ $application->employeeMiddlename}} {{ $application->employeeLastname}} (ID:- {{ $application->eUserId}}) Date & Time:-  {{ $application->updated_at}}</a>
                                @else
                                    <span class="label label-warning">Not Updated Yet</span>
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                            @if($storeProvisionalLetterAction == '1')
                                @if( $application->applicationstatusId =='1' )
                                    <a href="{{ url('/employee/provisional-letter/' . $application->id) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                @if( $application->studentUserID )
                                   <a href="{{ url('employee/users', $application->studentUserID) }}">{{ $application->studentUserFirstName }} {{ $application->studentUserLastName }}</a>
                                @else
                                    <span class="label label-warning">Not Updated Yet</span>
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                @if( $application->collegeprofileID )
                                   <a href="{{ url('employee/collegeprofile', $application->collegeprofileID) }}">{{ $application->collegeUserFirstName }}</a>
                                @else
                                    <span class="label label-warning">Not Updated Yet</span>
                                @endif
                            </td>
