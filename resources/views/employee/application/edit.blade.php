...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Application <!-- <a href="{{ URL::to('employee/application') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($application, ['method' => 'PATCH', 'url' => ['employee/application', $application->id], 'class' => 'form-horizontal', 'data-parsley-validate' => '']) !!}
           ...
           <!--  <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="4" placeholder="Enter the message" name="message" data-parsley-trigger="change" data-parsley-error-message="Please enter cancel reason" required=""></textarea>
                </div>
            </div>
           <!-- <div class="form-group">
