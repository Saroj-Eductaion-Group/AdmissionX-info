...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Create New Application Profile <!-- <a href="{{ url('employee/application') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::open(['url' => 'employee/application', 'class' => 'form-horizontal', 'data-parsley-validate' => '']) !!}

            <div class="form-group">
                <label class="col-sm-2 control-label" >Name : </label>
                <div class="col-sm-10">
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter name here', 'data-parsley-error-message' => 'Please enter name here', 'data-parsley-trigger'=>'change', 'required' => '',,'data-parsley-pattern'=>'^[a-zA-Z\s ]*$']) !!}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="applicationstatus_id" class="form-control chosen-select " data-parsley-error-message=" Please select application status" data-parsley-trigger="change" required="">
                        ...
                        @foreach ($applicationStatusObj as $application)
