...
<div class="profile-edit tab-pane fade in active margin-top30 white-popup">
	<div class="detail-page-signup">
		<div>
			<form method="POST" action="/user-group-table-emp-update" data-parsley-validate>
				...
				<div class="row padding-top5 padding-bottom5">
			     	<div class="col-md-2 col-sm-offset-10"><a href="{{ URL::to('/employee/usergroup-table-info/'.$slugUrl) }}" class="close">X</a></div>
		     	</div>
			    ...
			    <div class="row padding-top5 padding-bottom5">
                    <div class="col-sm-offset-8 col-sm-2 text-right">
                        <a href="{{ URL::to('/employee/usergroup-table-info/'.$slugUrl) }}" class="btn btn-default btn-sm form-control">Close</a>
                    </div>
                    <div class="col-sm-2">
