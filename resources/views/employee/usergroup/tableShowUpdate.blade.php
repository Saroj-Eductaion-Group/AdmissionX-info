...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>User Group Details <!-- <a href="{{ url('employee/usergroup/addtable') }}" class="btn btn-primary pull-right btn-sm">Add New Table</a> -->
        <a class="btn btn-primary pull-right btn-sm"  data-toggle="modal" data-target="#userGroupAddTableEmployeeModal" data-whatever="" href="">Add New Table</a>
        </h2>
    </div>
</div>
		            ...
		            <div class="ibox-content">
		               <table class="table table-hover">
		                    ...
		                    <tbody>
		                        ...
		                        <tr>
		                            <td><a href="{{ url('employee/usergroup', $item->id) }}">{{ $item->id }}</a></td>
		                            <td><a href="{{ url('employee/usergroup', $item->id) }}">{{ $item->tableName }}</a></td>
		                            <td>
		                                @if($item->eUserId)
		                            ...
		                            <td>
		                                ...
		                                {!! Form::open([
		                                    'method'=>'DELETE',
		                                    'url' => ['employee/usergroup', $item->id],
		                        ...
		                        <div class="modal fade" id="userGroupAddTableEmployeeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
								    <div class="modal-dialog" role="document">
								        <div class="modal-content">
								            <form method="POST" action="/employee/usergroup-add-table" data-parsley-validate>
