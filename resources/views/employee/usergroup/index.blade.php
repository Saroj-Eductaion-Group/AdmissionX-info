...
<div class="row wrapper border-bottom white-bg page-heading">
     <div class="col-lg-12">
        <h2>User Groups Details <a href="{{ url('employee/usergroup/create') }}" class="btn btn-primary pull-right btn-sm">Add New User Group</a></h2>
    </div>
</div>
            ...
            <div class="ibox-content">
               <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        {{--*/ $counter++ /*--}}
                        <tr>
                            <td><a href="{{ url('employee/usergroup-table-info', $item->slug) }}">{{ $counter }}</a></td>
                            <td><a href="{{ url('employee/usergroup-table-info', $item->slug) }}">{{ $item->userGroupName }}</a></td>
                            ...
                            @if($storeEditUpdateAction == '1')
                            <td>
                                <a class="btn btn-primary btn-xs"  data-toggle="modal" data-target="#userGroupEmployeeUpdateModal_{{ $counter }}" data-whatever="" href="">Update</a> /
                                <a href="{{ URL::to('employee/usergroup/delete', $item->id) }}" class='btn btn-danger btn-xs'>Delete</a>
                                

                                <div class="modal fade" id="userGroupEmployeeUpdateModal_{{ $counter }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            {!! Form::model($item, ['method' => 'PATCH', 'url' => ['employee/usergroup', $item->id], 'class' => 'form-horizontal homeLoginPopupWindow','data-parsley-validate' => '', 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
