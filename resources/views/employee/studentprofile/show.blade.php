    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
               <!-- <a href="{{ url('employee/studentprofile') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> -->
               <div class="row">
                   <div class="col-md-8">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('employee/users', $studentprofile->eUserId) }}">{{ $studentprofile->employeeFirstname }} {{ $studentprofile->employeeMiddlename}} {{ $studentprofile->employeeLastname}} (ID:- {{ $studentprofile->eUserId}}) Date & Time:-  {{ $studentprofile->updated_at}}</a>
                                        @else
                                ...
                                <tr>
                                    <th>Student Name</th>
                                    <td>
                                        <a href="{{ url('employee/users') }}/{{ $studentprofile->userID }}" title="{{ $studentprofile->firstname }} {{ $studentprofile->lastname }}">{{ $studentprofile->firstname }} {{ $studentprofile->lastname }} </a>                                        
                                    </td>
                                </tr>
                                <tr>
                                    <th>Parents Name</th>
