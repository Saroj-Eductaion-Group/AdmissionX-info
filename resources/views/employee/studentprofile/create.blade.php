...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Create New Student Profile <!-- <a href="{{ url('employee/studentprofile') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::open(['url' => 'employee/studentprofile', 'class' => 'form-horizontal','data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('parentsname', null, ['class' => 'form-control', 'placeholder' => 'Enter parent name here', 'data-parsley-error-message' => 'Please enter your parent name', 'required' => '','data-parsley-trigger'=>'change', 'data-parsley-pattern'=>'^[a-zA-Z\s .]*$']) !!}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('entranceexamnumber', null, ['class' => 'form-control', 'placeholder' => 'Enter entrance exam number here', 'data-parsley-error-message' => 'Please enter your entrance exam number', 'required' => '','data-parsley-trigger'=>'change','data-parsley-type'=>'digits','data-parsley-minlength'=>'1','data-parsley-maxlength'=>'5','maxlength'=>'5','data-parsley-max'=>'10000']) !!}
                </div>
            </div>
            <div class="form-group">
