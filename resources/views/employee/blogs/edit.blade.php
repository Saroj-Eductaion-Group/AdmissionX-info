...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Blogs <!-- <a href="{{ URL::to('employee/blogs') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($blog, ['method' => 'PATCH','url' => ['employee/blogs', $blog->id], 'class' => 'form-horizontal', 'data-parsley-validate' => '', 'files'=>true, 'enctype' => 'multipart/form-data']) !!}

            <div class="form-group">
                <label class="col-sm-2 control-label" >Topic of the blog : </label>
                <div class="col-sm-10">
                    {!! Form::text('topic', null, ['class' => 'form-control', 'placeholder' => 'Enter topic of blogs here', 'data-parsley-error-message' => 'Please enter topic of blogs here','data-parsley-trigger'=>'change','data-parsley-pattern'=>'^[a-zA-Z0-9\\/s ().,-]*$']) !!}
                </div>
            </div>
            <div class="form-group">
