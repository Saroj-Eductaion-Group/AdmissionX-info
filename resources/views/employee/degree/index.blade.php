            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-degree', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">      
                                            <a href="{{ URL::to('employee/degree') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($degree as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/degree', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/degree', $item->id) }}">{{ $item->name }}</a></td>
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/degree/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a><!--  /
                                        {!! Form::open(['method'=>'DELETE','url' => ['employee/degree', $item->id],'style' => 'display:inline'
                                        ]) !!}
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.degreeSearchDataObj, function (key, item) {
                                ...
                                if( data.degreeSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.degreeSearchDataObj[key].eUserId +"/') !!}' >"+ data.degreeSearchDataObj[key].employeeFirstname+' '+data.degreeSearchDataObj[key].employeeMiddlename+' '+data.degreeSearchDataObj[key].employeeLastname+' (User Id:- '+data.degreeSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.degreeSearchDataObj[key].updated_at +"</a>";
                                }
                                
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/degree/"+ data.degreeSearchDataObj[key].degreeId +"/') !!}' >"+ data.degreeSearchDataObj[key].degreeId +"</a></td><td><a href='{!! URL::to('employee/degree/"+ data.degreeSearchDataObj[key].degreeId +"/') !!}' >"+ degreeDataText +"</a></td><td>"+ functionalAreaNameDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/degree/"+ data.degreeSearchDataObj[key].degreeId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-degree') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Degree Name</td><td class='searchFilter'>Stream</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].name == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/degree/"+ data[key].degreeId +"/') !!}' >"+ data[key].degreeId +"</a></td><td><a href='{!! URL::to('employee/degree/"+ data[key].degreeId +"/') !!}' >"+ degreeDataText +"</a></td><td>"+ functionalAreaNameDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/degree/"+ data[key].degreeId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-degree') }}",
