	...
	<div class="container cooming-soon-content valign__middle">
		...
		<div class="row">
			<div class="col-md-12 coming-soon">
				...
				<h2 class="test-info">Thank you for login to <span class="color-green">AdmissionX </span></h2><br>
				...
				<a href="{{ URL::to('/') }}" class="btn-u" title="Take me to home">Take me to home</a>
				
				<a href="{{ URL::to('logout') }}" title="Log Out" class="btn-u fa fa-sign-out hide"> Log Out </a>
			...
			<div class="row">
				...
				<div class="col-sm-6 text-right">
					<ul class="list-inline coming-soon-social">
						...
						<li><a href="https://in.linkedin.com/in/admissionx" target="_blank" title="Connect with us on LinkedIn"><i class="fa fa-linkedin"></i></a></li>						
					</ul>
				</div>
			</div>
		</div>
