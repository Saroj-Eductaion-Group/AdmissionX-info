...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>College Profile Details <!-- <a href="{{ url('employee/collegeprofile/create') }}" class="btn btn-primary pull-right btn-sm">Add New College Profile</a> --></h2>    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                ...
                <form action="{{ URL::to('/employee/collegeprofile') }}" method="GET">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">      
                                    <a href="{{ URL::to('/employee/collegeprofile') }}" class="btn btn-md btn-primary">Clear</a>
            ...
            <div class="ibox-content table-responsive">
                ...
                <table class="table table-hover">
                    ...
                    <tbody class="tbody">
                        ...
                        <tr class="gradeX">
                            <td>
                                <a href="{{ url('employee/users', $item->userID) }}">{{ $item->id }}</a>
                            </td>
                            <td>
                                @if( $item->created_at)
