    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
               <!-- <a href="{{ url('employee/collegeprofile') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> -->
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="headline"><h2>College Information</h2></div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('employee/users', $collegeprofile->eUserId) }}">{{ $collegeprofile->employeeFirstname }} {{ $collegeprofile->employeeMiddlename}} {{ $collegeprofile->employeeLastname}} (ID:- {{ $collegeprofile->eUserId}}) Date & Time:-  {{ $collegeprofile->updated_at}}</a>
                                        @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if( $collegeprofile->userID)
                                            <a href="{{ url('employee/users') }}/{{ $collegeprofile->userID }}" title="{{ $collegeprofile->firstname }} {{ $collegeprofile->lastname }}">{{ $collegeprofile->firstname }} {{ $collegeprofile->lastname }} </a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
