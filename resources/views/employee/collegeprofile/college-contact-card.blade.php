...
<div class="ibox-content">
    ...
    <div class="slideDown" style="visibility:hidden">
        ...
        <form action="/employee/collegeprofile-info/contact-card" method="GET" class="form-horizontal" data-parsley-validate>
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="hr-line-dashed"></div>
                    <div class="col-md-12 text-right">      
                        <a href="{{ URL::to('employee/collegeprofile-info/contact-card') }}" class="btn btn-default btn-sm">Close</a>
			...
			<div class="row filtercard">
				...
				<div class="col-lg-4">
					<div class="contact-box">
					    <a href="{{ url('/employee/collegeprofile', $item->id) }}">
					    <div class="col-sm-4">
