               ...
               <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        @foreach($userprivilege as $key => $item)
                         {{--*/ $counter++ /*--}}
                        <tr>
                            <td><a href="{{ url('employee/userprivilege-table-info', $item->usersId) }}">{{ $counter }}</a></td>
                            <td><a href="{{ url('employee/userprivilege-table-info', $item->usersId) }}">{{ $item->firstname }} {{ $item->middlename }} {{ $item->lastname }}</a></td>
                            <td>
                                @if($item->eUserId)
                            ...
                            <td>
                                <a href="{{ URL::to('employee/userprivilege/delete', $item->usersId) }}" class='btn btn-danger btn-xs'>Delete</a>
                            </td>                          
                        </tr>
                        @endforeach
                    </tbody>
