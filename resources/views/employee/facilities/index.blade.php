            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-facilities', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">      
                                            <a href="{{ URL::to('employee/facilities') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($facilities as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/facilities', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/facilities', $item->id) }}">{{ $item->name }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/facilities/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a><!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/facilities', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.facilitySearchDataObj, function (key, item) {
                                ...
                                if( data.facilitySearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.facilitySearchDataObj[key].eUserId +"/') !!}' >"+ data.facilitySearchDataObj[key].employeeFirstname+' '+data.facilitySearchDataObj[key].employeeMiddlename+' '+data.facilitySearchDataObj[key].employeeLastname+' (User Id:- '+data.facilitySearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.facilitySearchDataObj[key].updated_at +"</a>";
                                }

                                 

                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/facilities/"+ data.facilitySearchDataObj[key].facilitiesId +"/') !!}' >"+ data.facilitySearchDataObj[key].facilitiesId +"</a></td><td><a href='{!! URL::to('employee/facilities/"+ data.facilitySearchDataObj[key].facilitiesId +"/') !!}' >"+ facilityNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/facilities/"+ data.facilitySearchDataObj[key].facilitiesId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-facilities') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Facilities Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].name == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/facilities/"+ data[key].facilitiesId +"/') !!}' >"+ data[key].facilitiesId +"</a></td><td><a href='{!! URL::to('employee/facilities/"+ data[key].facilitiesId +"/') !!}' >"+ facilityNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/facilities/"+ data[key].facilitiesId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-facilities') }}",
