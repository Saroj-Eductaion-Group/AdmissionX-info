...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Event <!-- <a href="{{ url('employee/event') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter name here', 'data-parsley-error-message' => 'Please enter name here', 'required' => '', 'data-parsley-trigger'=>'change','data-parsley-pattern'=>'^[a-zA-Z0-9\\/s &().,-]*$']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="datetime" id="datePickerForSelection" readonly="" placeholder="Select date here" required="" data-parsley-trigger="change" data-parsley-error-message="Please select date here" value="{{ date('d/m/Y', strtotime($event->datetime)) }}">                   
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('venue', null, ['class' => 'form-control', 'placeholder' => 'Enter venue here', 'data-parsley-error-message' => 'Please enter venue here', 'data-parsley-trigger'=>'change','data-parsley-pattern'=>'^[a-zA-Z0-9\\/s &().,-]*$']) !!}
                </div>
            </div>
            ...
            <!-- <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('link', null, ['class' => 'form-control', 'placeholder' => 'Enter link here', 'data-parsley-error-message' => 'Please enter link here', 'required' => '', 'data-parsley-trigger'=>'change']) !!}
                </div>
            </div> -->
            <div class="form-group">
                    ...
                    <select name="collegeprofile_id" class="form-control chosen-select " data-placeholder="Choose college profile..."  data-parsley-error-message=" Please select college profile" data-parsley-trigger="change">
                       ...
                       <!--  @foreach( $collegeProfileObj as $college )
                            @if( $college->userRoleId == '2' )
                                @if( $event->collegeprofile_id == $college->id )
