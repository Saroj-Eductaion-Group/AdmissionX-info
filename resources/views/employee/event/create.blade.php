...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Create New Event <!-- <a href="{{ url('employee/event') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::open(['url' => 'employee/event', 'class' => 'form-horizontal','data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                     ...
                     {!! Form::date('datetime', null, ['class' => 'form-control', 'placeholder' => 'Enter datetime here', 'data-parsley-error-message' => 'Please enter datetime here', 'required' => '', 'data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
