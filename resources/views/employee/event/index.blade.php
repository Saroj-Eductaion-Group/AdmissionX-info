            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-college-event', 'class' => 'form-horizontal search-form search-form']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="row">  
                                        <div class="col-md-12 text-right">      
                                            <a href="{{ URL::to('employee/event') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($event as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/event', $item->id) }}">{{ $item->id }}</a></td>
                                    <td>
                                        @if( $item->eventName)
                                           <a href="{{ url('employee/event', $item->id) }}">{{ $item->eventName }}</a>
                                        @else
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/event/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> <!-- /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/event', $item->id],
...
$(document).ready(function(){
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.eventSearchDataObj, function (key, item) {
                                ...
                                if( data.eventSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.eventSearchDataObj[key].eUserId +"/') !!}' >"+ data.eventSearchDataObj[key].employeeFirstname+' '+data.eventSearchDataObj[key].employeeMiddlename+' '+data.eventSearchDataObj[key].employeeLastname+' (User Id:- '+data.eventSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.eventSearchDataObj[key].updated_at +"</a>";
                                }

                  
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/event/"+ data.eventSearchDataObj[key].eventId +"/') !!}' >"+ data.eventSearchDataObj[key].eventId +"</a></td><td><a href='{!! URL::to('employee/event/"+ data.eventSearchDataObj[key].eventId +"/') !!}' >"+ eventNameDataText +"</a></td><td>"+ eventDateText +"</td> <td>"+ venueDataText +"</td> <td><a href='{!! URL::to('employee/collegeprofile/"+ data.eventSearchDataObj[key].collegeprofileID +"/') !!}' >"+ data.eventSearchDataObj[key].firstname + "</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/event/"+ data.eventSearchDataObj[key].eventId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-college-event') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id </td><td class='searchFilter'>Name</td><td class='searchFilter'>Date</td><td class='searchFilter'>Venue</td><td class='searchFilter'>College Profile</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].datetime == null ){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/event/"+ data[key].eventId +"/') !!}' >"+ data[key].eventId +"</a></td><td><a href='{!! URL::to('employee/event/"+ data[key].eventId +"/') !!}' >"+ eventNameDataText +"</a></td><td>"+ eventDateText +"</td> <td>"+ venueDataText +"</td> <td><a href='{!! URL::to('employee/collegeprofile/"+ data[key].collegeprofileID +"/') !!}' >"+ data[key].firstname + "</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/event/"+ data[key].eventId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-college-event') }}",
