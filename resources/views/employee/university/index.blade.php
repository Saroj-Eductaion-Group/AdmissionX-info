...
<!-- <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>University Details <a href="{{ url('employee/university/create') }}" class="btn btn-primary pull-right btn-sm">Add New University</a></h2>
    </div>
</div> -->
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-university', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h4 for="usr">University Name<span class="pull-right"><a href="javascript:void(0);" id="refresh1" class="hide"><i class="fa fa-remove"></i></a></span></h4>
                                            <input type="text" class="form-control universityName" name="universityName" placeholder="Enter university name here" data-parsley-error-message="Please enter university name" data-parsley-trigger="change">
                                        </div>  
                                                                                
                                        <div class="col-md-6 text-right">      
                                            <a href="{{ URL::to('employee/university') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        @if( $university == '0' )
                            <input type="text" class="result-zero hide" value="{{ $university }}">
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($university as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/university', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/university', $item->id) }}">{{ $item->name }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/university/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a><!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/university', $item->id],
                        ...
                        <div class="row indexPagination">
                            <div class="col-md-12">
                                <div class="pull-right custom-pagination">{!! $university->render() !!}</div>
                            </div>
                        </div>
                        @endif
   ...
   <!-- Page-Level Scripts -->
    <script>
        $(document).ready(function() {
            ...
            $('.universityName').on('blur',function(){
            ...
            $('.search-form').on('submit',function(e){
                ...
                $.ajax({
                    ...
                    success  : function(data) {
                        ...
                        $(".thead").empty();
                        $(".tbody").empty();
                        $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>University Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.universitySearchDataObj, function (key, item) {

                                if( data.universitySearchDataObj[key].name == ''){
                                     universityNameDataText = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    universityNameDataText = data.universitySearchDataObj[key].name;
                                }

                                 if( data.universitySearchDataObj[key].eUserId == null ){
                                    lastUpdatedBy = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.universitySearchDataObj[key].eUserId +"/') !!}' >"+ data.universitySearchDataObj[key].employeeFirstname+' '+data.universitySearchDataObj[key].employeeMiddlename+' '+data.universitySearchDataObj[key].employeeLastname+' (User Id:- '+data.universitySearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.universitySearchDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/university/"+ data.universitySearchDataObj[key].universityId +"/') !!}' >"+ data.universitySearchDataObj[key].universityId +"</a></td><td><a href='{!! URL::to('employee/university/"+ data.universitySearchDataObj[key].universityId +"/') !!}' >"+ universityNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/university/"+ data.universitySearchDataObj[key].universityId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                                
                            });

                            //Create html pagination desgin
                            if( data.universitySearchDataObj1 > 1 ){
                                var HTML = '';
                                HTML +='<ul class="pagination">';
                                HTML +='<li class="active"><span class="currentCounter">1</span></li>';
                                if( data.universitySearchDataObj1 < 8 ){
                                    for(var i=2; i <= data.universitySearchDataObj1; i++){
                                ...
                                if( data.universitySearchDataObj1 < 8 ){
                                    ...
                                    var lessTwo = data.universitySearchDataObj1-1;
                                    for(var i=lessTwo; i <= data.universitySearchDataObj1; i++){
                                        HTML +='<li><span class="currentCounter">'+ i +'</span></li>';
                                    } 
                                }
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-university') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>University Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].name == ''){
                                    ...
                                    universityNameDataText = data[key].name;
                                }
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/university/"+ data[key].universityId +"/') !!}' >"+ data[key].universityId +"</a></td><td><a href='{!! URL::to('employee/university/"+ data[key].universityId +"/') !!}' >"+ universityNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/university/"+ data[key].universityId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-university') }}",
                    data     : { universityName:universityName, currentNode: currentNode },
                    dataType : "json",
                    success: function(data) {
                        $('.prevFilter').show();
                        $('.spiner-example').addClass('hide');
                        ...
                        if( data == 'no' ){
                            ...
                            if( data.currentNode >= 8 ){
                                ...
                                for( var adds = plusOne; adds <= addInCurrentNode; adds++ ){
                                    if( data.universitySearchDataObj1 > adds ){
