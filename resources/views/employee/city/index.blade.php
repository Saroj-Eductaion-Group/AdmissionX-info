            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-city-name', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 text-right pull-right">      
                                            <a href="{{ URL::to('employee/city') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($city as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/city', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/city', $item->id) }}">{{ $item->name }}</a></td>
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/city/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a><!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/city', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.citySearchDataObj, function (key, item) {
                                ...
                                if( data.citySearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.citySearchDataObj[key].eUserId +"/') !!}' >"+ data.citySearchDataObj[key].employeeFirstname+' '+data.citySearchDataObj[key].employeeMiddlename+' '+data.citySearchDataObj[key].employeeLastname+' (User Id:- '+data.citySearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.citySearchDataObj[key].updated_at +"</a>";
                                }
                                
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/city/"+ data.citySearchDataObj[key].cityID +"/') !!}' >"+ data.citySearchDataObj[key].cityID +"</a></td><td><a href='{!! URL::to('employee/city/"+ data.citySearchDataObj[key].cityID +"/') !!}' >"+ cityNameDataText +"</a></td><td>"+ cityStatusText +"</td><td>"+ stateDataText +"</td><td>"+ countryDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/city/"+ data.citySearchDataObj[key].cityID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-city-name') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>City Name</td><td class='searchFilter'>City Status</td><td class='searchFilter'>State Name</td><td class='searchFilter'>Country Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].stateName == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/city/"+ data[key].cityID +"/') !!}' >"+ data[key].cityID +"</a></td><td><a href='{!! URL::to('employee/city/"+ data[key].cityID +"/') !!}' >"+ cityNameDataText +"</a></td><td>"+ cityStatusText +"</td><td>"+ stateDataText +"</td><td>"+ countryDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/city/"+ data[key].cityID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-city-name') }}",
