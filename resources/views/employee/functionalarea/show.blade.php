    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content table-responsive">
               <!-- <a href="{{ url('employee/functionalarea') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> -->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('employee/users', $functionalarea->eUserId) }}">{{ $functionalarea->employeeFirstname }} {{ $functionalarea->employeeMiddlename}} {{ $functionalarea->employeeLastname}} (ID:- {{ $functionalarea->eUserId}}) Date & Time:-  {{ $functionalarea->updated_at}}</a>
                                @else
