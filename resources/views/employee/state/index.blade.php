            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-state-name', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">      
                                            <a href="{{ URL::to('employee/state') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($state as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/state', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/state', $item->id) }}">{{ $item->name }}</a></td>
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/state/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a><!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/state', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.stateSearchDataObj, function (key, item) {
                                ...
                                if( data.stateSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.stateSearchDataObj[key].eUserId +"/') !!}' >"+ data.stateSearchDataObj[key].employeeFirstname+' '+data.stateSearchDataObj[key].employeeMiddlename+' '+data.stateSearchDataObj[key].employeeLastname+' (User Id:- '+data.stateSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.stateSearchDataObj[key].updated_at +"</a>";
                                }

                               
                                
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/state/"+ data.stateSearchDataObj[key].stateId +"/') !!}' >"+ data.stateSearchDataObj[key].stateId +"</a></td><td><a href='{!! URL::to('employee/state/"+ data.stateSearchDataObj[key].stateId +"/') !!}' >"+ stateNameDataText +"</a></td><td>"+ countryDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/state/"+ data.stateSearchDataObj[key].stateId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-state-name') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>State Name</td><td class='searchFilter'>Country Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].countryName == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/state/"+ data[key].stateId +"/') !!}' >"+ data[key].stateId +"</a></td><td><a href='{!! URL::to('employee/state/"+ data[key].stateId +"/') !!}' >"+ stateNameDataText +"</a></td><td>"+ countryDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/state/"+ data[key].stateId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-state-name') }}",
