...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Create New User <!-- <a href="{{ url('employee/users') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                {!! Form::open(['url' => 'employee/users', 'class' => 'form-horizontal','data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
                <div class="row">
                ...
                <div class="middleLastForm hide">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="lastName" placeholder="Enter last name here"  data-parsley-trigger="change" data-parsley-error-message="Please enter your last name" data-parsley-pattern="^[a-zA-Z\s .]*$">
                        </div>
                    </div>
                </div>
                ...
                <div class="restForm hide">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="phone" placeholder="Enter phone number here" data-parsley-type ="digits" data-parsley-error-message = "Please enter valid phone number"  data-parsley-trigger="change" data-parsley-type="digits" ><!-- data-parsley-length="[7, 12]" data-parsley-trigger="change" data-parsley-maxlength="12" maxlength="12" -->
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
