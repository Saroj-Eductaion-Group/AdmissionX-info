            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-course', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">      
                                            <a href="{{ URL::to('employee/course') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($course as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/course', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/course', $item->id) }}">{{ $item->name }}</a></td>
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/course/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a><!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/course', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.courseSearchDataObj, function (key, item) {
                                ...
                                if( data.courseSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.courseSearchDataObj[key].eUserId +"/') !!}' >"+ data.courseSearchDataObj[key].employeeFirstname+' '+data.courseSearchDataObj[key].employeeMiddlename+' '+data.courseSearchDataObj[key].employeeLastname+' (User Id:- '+data.courseSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.courseSearchDataObj[key].updated_at +"</a>";
                                }
                                
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/course/"+ data.courseSearchDataObj[key].courseID +"/') !!}' >"+ data.courseSearchDataObj[key].courseID +"</a></td><td><a href='{!! URL::to('employee/course/"+ data.courseSearchDataObj[key].courseID +"/') !!}' >"+ courseNameDataText +"</a></td><td>"+ degreeDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/course/"+ data.courseSearchDataObj[key].courseID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-course') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Course Name</td><td class='searchFilter'>Degree Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].eUserId == null ){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/course/"+ data[key].courseID +"/') !!}' >"+ data[key].courseID +"</a></td><td><a href='{!! URL::to('employee/course/"+ data[key].courseID +"/') !!}' >"+ courseNameDataText +"</a></td><td>"+ degreeDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/course/"+ data[key].courseID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-course') }}",
