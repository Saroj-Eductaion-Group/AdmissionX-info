...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Course <!-- <a href="{{ url('employee/course') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                {!! Form::model($course, [ 'method' => 'PATCH',  'url' => ['employee/course', $course->id],        'class' => 'form-horizontal', 'data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
                   <div class="ibox-content">
                        {!! Form::model($course, [ 'method' => 'PATCH',  'url' => ['administrator/course', $course->id],        'class' => 'form-horizontal', 'data-parsley-validate' => '']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter course name here', 'data-parsley-error-message' => 'Please enter course name here', 'data-parsley-trigger'=>'change', 'required' => '','data-parsley-pattern'=>'^[a-zA-Z\\/s &().,-]*$']) !!}
                        </div>
                    </div>
