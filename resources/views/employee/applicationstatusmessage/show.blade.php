    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
              <!--  <a href="{{ url('employee/applicationstatusmessage') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> -->
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                @if( $applicationstatusmessage->applicationId )
                                   <a href="{{ url('employee/application', $applicationstatusmessage->applicationId) }}">{{ $applicationstatusmessage->applicationId }}</a> 
                                @else
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('employee/users', $applicationstatusmessage->eUserId) }}">{{ $applicationstatusmessage->employeeFirstname }} {{ $applicationstatusmessage->employeeMiddlename}} {{ $applicationstatusmessage->employeeLastname}} (ID:- {{ $applicationstatusmessage->eUserId}}) Date & Time:-  {{ $applicationstatusmessage->updated_at}}</a>
                                @else
                                    <span class="label label-warning">Not Updated Yet</span>
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                @if( $applicationstatusmessage->studentUserFirstName )
                                   <a href="{{ url('employee/studentprofile', $applicationstatusmessage->studentprofileId) }}">{{ $applicationstatusmessage->studentUserFirstName }} {{ $applicationstatusmessage->studentUserMiddleName }} {{ $applicationstatusmessage->studentUserLastName }}</a>
                                @else
                                    <span class="label label-warning">Not Updated Yet</span>
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                @if( $applicationstatusmessage->collegeprofileID )
                                   <a href="{{ url('employee/collegeprofile', $applicationstatusmessage->collegeprofileID) }}">{{ $applicationstatusmessage->collegeUserFirstName }}</a>
                                @else
                                    <span class="label label-warning">Not Updated Yet</span>
                                @endif
                            </td>
