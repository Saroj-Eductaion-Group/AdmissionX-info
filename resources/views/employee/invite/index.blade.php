            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-invite', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="col-md-12 text-right">      
                                        <a href="{{ URL::to('employee/invite') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($invite as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/invite', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/invite', $item->id) }}">{{ $item->link }}</a></td>
                                    ...
                                    <td><a href="{{ url('employee/users') }}/{{ $item->userID }}" title="{{ $item->firstname }} {{ $item->lastname }}">{{ $item->firstname }} {{ $item->lastname }} </a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/invite/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a><!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/invite', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.inviteSearchDataObj, function (key, item) {
                                ...
                                if( data.inviteSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.inviteSearchDataObj[key].eUserId +"/') !!}' >"+ data.inviteSearchDataObj[key].employeeFirstname+' '+data.inviteSearchDataObj[key].employeeMiddlename+' '+data.inviteSearchDataObj[key].employeeLastname+' (User Id:- '+data.inviteSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.inviteSearchDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/invite/"+ data.inviteSearchDataObj[key].inviteId +"/') !!}' >"+ data.inviteSearchDataObj[key].inviteId +"</a></td><td><a href='{!! URL::to('employee/invite/"+ data.inviteSearchDataObj[key].inviteId +"/') !!}' >"+ linkDataText +"</a></td><td>"+ referEmailDataText +"</td><td>"+ verifyDataText +"</td><td><a href='{!! URL::to('employee/user/"+ data.inviteSearchDataObj[key].userID +"/') !!}' >"+ usernameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/invite/"+ data.inviteSearchDataObj[key].inviteId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-invite') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Link</td><td class='searchFilter'>Referemail</td><td class='searchFilter'>Active</td><td class='searchFilter'>User name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].link == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/invite/"+ data[key].inviteId +"/') !!}' >"+ data[key].inviteId +"</a></td><td><a href='{!! URL::to('employee/invite/"+ data[key].inviteId +"/') !!}' >"+ linkDataText +"</a></td><td>"+ referEmailDataText +"</td><td>"+ verifyDataText +"</td><td><a href='{!! URL::to('employee/user/"+ data[key].userID +"/') !!}' >"+ usernameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/invite/"+ data[key].inviteId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-invite') }}",
