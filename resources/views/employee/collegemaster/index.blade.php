...
<!-- <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
         <h2>College Course Details <a href="{{ url('employee/collegemaster/create') }}" class="btn btn-primary pull-right btn-sm">Add New College Course</a></h2>
    </div>
</div> -->
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-college-master', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="hr-line-dashed"></div>
                                     <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h4 for="usr">Total Fees<span class="pull-right"><a href="javascript:void(0);" id="refresh10" class="hide"><i class="fa fa-remove"></i></a></span></h4>
                                    ...
                                    <div class="hr-line-dashed"></div>
                                     <div class="row">
                                        <div class="col-md-12 text-right">      
                                            <a href="{{ URL::to('employee/collegemaster') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class="table-responsive"> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($collegemaster as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/collegemaster', $item->id) }}">{{ $item->id }}</a></td>
                                    <td>
                                        @if( $item->twelvemarks)
                                           <a href="{{ url('employee/collegemaster', $item->id) }}"> {{ $item->twelvemarks }}</a>
                                        @else
                                    ...
                                    <td> @if( $item->collegeprofileID)
                                            <a href="{{ url('employee/collegeprofile') }}/{{ $item->collegeprofileID }}" title="{{ $item->firstname }} {{ $item->lastname }}">{{ $item->firstname }} {{ $item->lastname }} </a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        @if( $item->functionalAreaName)
                                            <a href="{{ url('employee/functionalarea') }}/{{ $item->functionalareaID }}" title="{{ $item->firstname }} {{ $item->lastname }}">{{ $item->functionalAreaName }}</a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if( $item->educationlevelName)
                                            <a href="{{ url('employee/educationlevel') }}/{{ $item->educationlevelId }}" title="{{ $item->firstname }} {{ $item->lastname }}">{{ $item->educationlevelName }}</a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if( $item->degreeName)
                                            <a href="{{ url('employee/degree') }}/{{ $item->degreeId }}" title="{{ $item->firstname }} {{ $item->lastname }}">{{ $item->degreeName }}</a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if( $item->coursetypeName)
                                            <a href="{{ url('employee/coursetype') }}/{{ $item->coursetypeId }}" title="{{ $item->firstname }} {{ $item->lastname }}">{{ $item->coursetypeName }}</a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if( $item->courseName)
                                           <a href="{{ url('employee/course') }}/{{ $item->courseID }}" title="{{ $item->courseName }} {{ $item->lastname }}"> {{ $item->courseName }}</a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/collegemaster/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> <!-- /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/collegemaster', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.collegeMasterDataObj, function (key, item) {
                                ...
                                if( data.collegeMasterDataObj[key].functionalAreaName == null){
                                    ...
                                    functionalAreaText = "<a class='' href='{!! URL::to('employee/functionalarea/"+ data.collegeMasterDataObj[key].functionalareaID +"/') !!}' >"+data.collegeMasterDataObj[key].functionalAreaName+ "</a>";
                                }
                                ...
                                if(data.collegeMasterDataObj[key].educationlevelName == null ){
                                    ...
                                    educationLevelDataText = "<a class='' href='{!! URL::to('employee/educationlevel/"+ data.collegeMasterDataObj[key].educationlevelId +"/') !!}' >"+data.collegeMasterDataObj[key].educationlevelName + "</a>";
                                }

                                if(data.collegeMasterDataObj[key].degreeName == null ){
                                    degreeDataText = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    degreeDataText = "<a class='' href='{!! URL::to('employee/degree/"+ data.collegeMasterDataObj[key].degreeId +"/') !!}' >"+data.collegeMasterDataObj[key].degreeName+ "</a>";
                                }
                                ...
                                if(data.collegeMasterDataObj[key].coursetypeName == null ){
                                    ...
                                    courseTypeDataText = "<a class='' href='{!! URL::to('employee/coursetype/"+ data.collegeMasterDataObj[key].coursetypeId +"/') !!}' >"+data.collegeMasterDataObj[key].coursetypeName+ "</a>";
                                }

                                if( data.collegeMasterDataObj[key].courseName == null ){
                                    courseDataText = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    courseDataText = "<a class='' href='{!! URL::to('employee/course/"+ data.collegeMasterDataObj[key].courseID +"/') !!}' >"+ data.collegeMasterDataObj[key].courseName + "</a>";
                                }

                                if( data.collegeMasterDataObj[key].eUserId == null ){
                                    lastUpdatedBy = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.collegeMasterDataObj[key].eUserId +"/') !!}' >"+ data.collegeMasterDataObj[key].employeeFirstname+' '+data.collegeMasterDataObj[key].employeeMiddlename+' '+data.collegeMasterDataObj[key].employeeLastname+' (User Id:- '+data.collegeMasterDataObj[key].eUserId+') <hr> Date & Time :- '+data.collegeMasterDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/collegemaster/"+ data.collegeMasterDataObj[key].collegemasterId +"/') !!}' >"+ data.collegeMasterDataObj[key].collegemasterId +"</a></td><td><a href='{!! URL::to('employee/collegemaster/"+ data.collegeMasterDataObj[key].collegemasterId +"/') !!}' >"+ twelveMarksDataText +"</a></td><td>"+ otherDataText +"</td><td>"+ totalFeeText +"</td><td>"+ totalSeatText +"</td><td>"+ seatsallocatedtobyaDataText +"</td><td><a href='{!! URL::to('employee/collegeprofile/"+ data.collegeMasterDataObj[key].collegeprofileID +"/') !!}' >"+ data.collegeMasterDataObj[key].firstname + "</a></td> <td>"+ functionalAreaText +"</td> <td>"+ educationLevelDataText +"</td> <td>"+ degreeDataText +"</td> <td>"+ courseTypeDataText +"</td> <td>"+ courseDataText +"</td><td>"+ lastUpdatedBy +" </td> <td><a href='{!! URL::to('employee/collegemaster/"+ data.collegeMasterDataObj[key].collegemasterId +"/edit/') !!}' class='btn btn-primary btn-xs'>Update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-college-master') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'> Id</td><td class='searchFilter'>12th Marks</td><td class='searchFilter'>Others</td><td class='searchFilter'>Total Fees</td><td class='searchFilter'>Total Seats</td><td class='searchFilter'>Seats Allocated To Admission X</td><td class='searchFilter'>College Profile </td><td class='searchFilter'>Stream</td><td class='searchFilter'>Degree Level</td><td class='searchFilter'>Degree</td><td class='searchFilter'>Course Type</td><td class='searchFilter'>Course</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].twelvemarks == null){
                                ...
                                if( data[key].functionalAreaName == null){
                                    ...
                                    functionalAreaText = "<a class='' href='{!! URL::to('employee/functionalarea/"+ data[key].functionalareaID +"/') !!}' >"+data[key].functionalAreaName+ "</a>";
                                }

                                if(data[key].educationlevelName == null ){
                                    educationLevelDataText = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    educationLevelDataText = "<a class='' href='{!! URL::to('employee/educationlevel/"+ data[key].educationlevelId +"/') !!}' >"+data[key].educationlevelName + "</a>";
                                }

                                if(data[key].degreeName == null ){
                                    degreeDataText = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    degreeDataText = "<a class='' href='{!! URL::to('employee/degree/"+ data[key].degreeId +"/') !!}' >"+data[key].degreeName+ "</a>";
                                }

                                if(data[key].coursetypeName == null ){
                                    courseTypeDataText = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    courseTypeDataText = "<a class='' href='{!! URL::to('employee/coursetype/"+ data[key].coursetypeId +"/') !!}' >"+data[key].coursetypeName+ "</a>";
                                }

                                if( data[key].courseName == null ){
                                    courseDataText = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    courseDataText = "<a class='' href='{!! URL::to('employee/course/"+ data[key].courseID +"/') !!}' >"+ data[key].courseName + "</a>";
                                }
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/collegemaster/"+ data[key].collegemasterId +"/') !!}' >"+ data[key].collegemasterId +"</a></td><td><a href='{!! URL::to('employee/collegemaster/"+ data[key].collegemasterId +"/') !!}' >"+ twelveMarksDataText +"</a></td><td>"+ otherDataText +"</td><td>"+ totalFeeText +"</td><td>"+ totalSeatText +"</td><td>"+ seatsallocatedtobyaDataText +"</td><td><a href='{!! URL::to('employee/collegeprofile/"+ data[key].collegeprofileID +"/') !!}' >"+ data[key].firstname + "</a></td> <td>"+ functionalAreaText +"</td> <td>"+ educationLevelDataText +"</td> <td>"+ degreeDataText +"</td> <td>"+ courseTypeDataText +"</td> <td>"+ courseDataText +"</td><td>"+ lastUpdatedBy +" </td> <td><a href='{!! URL::to('employee/collegemaster/"+ data[key].collegemasterId +"/edit/') !!}' class='btn btn-primary btn-xs'>Update</a></td></tr>");
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-college-master') }}",
