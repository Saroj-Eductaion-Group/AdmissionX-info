            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-college-faculty', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                    ...
                                    <div class="hr-line-dashed"></div>
                                     <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">      
                                            <a href="{{ URL::to('employee/faculty') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class="table-responsive"> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($faculty as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/faculty', $item->id) }}">{{ $item->id }}</a></td>
                                    <td>        
                                        <a href="{{ url('employee/faculty', $item->id) }}">
                                            @if( $item->name )
                                    ...
                                    <td><a href="{{ URL('employee/collegeprofile/'. $item->collegeprofileId) }}">{{ $item->firstname }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/faculty/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a>/ <a href="{{ url('employee/faculty', $item->id) }}"><button type="submit" class="btn btn-info btn-xs">Show</button></a>
                                        <!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/faculty', $item->id],
        ...
        $(document).ready(function() {
                           ...
                           /* $.each(data.getTotalCount, function (key, item) {
                            ...
                            $.each(data.facultyDataObj, function (key, item) {
                                ...
                                if( data.facultyDataObj[key].collegemasterId == null){
                                    ...
                                    courseDetailsText = "<a class='' href='{!! URL::to('employee/collegemaster/"+ data.facultyDataObj[key].collegemasterId +"/') !!}' >"+ functionalAreaText +' / '+ degreeDataText +' / '+ courseDataText + "</a>";
                                }
                               
                                if( data.facultyDataObj[key].eUserId == null ){
                                    lastUpdatedBy = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.facultyDataObj[key].eUserId +"/') !!}' >"+ data.facultyDataObj[key].employeeFirstname+' '+data.facultyDataObj[key].employeeMiddlename+' '+data.facultyDataObj[key].employeeLastname+' (User Id:- '+data.facultyDataObj[key].eUserId+') <hr> Date & Time :- '+data.facultyDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/faculty/"+ data.facultyDataObj[key].facultyId +"/') !!}' >"+ data.facultyDataObj[key].facultyId +"</a></td><td>"+ facultyNameText +"</td><td>"+ facultyDescriptionText +"</td><td>"+ courseDetailsText +"</td><td><a href='{!! URL::to('employee/collegeprofile/"+ data.facultyDataObj[key].collegeprofileId +"/') !!}' >"+ data.facultyDataObj[key].firstname + "</a></td> <td>"+ lastUpdatedBy +" </td> <td><a href='{!! URL::to('employee/faculty/"+ data.facultyDataObj[key].facultyId +"/edit/') !!}' class='btn btn-primary btn-xs'>Update</a>/<a href='{!! URL::to('employee/faculty/"+ data.facultyDataObj[key].facultyId +"') !!}' class='btn btn-info btn-xs'>Show</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-college-faculty') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'> Id</td><td class='searchFilter'>Name</td><td class='searchFilter'>Description</td><td class='searchFilter'>Course Detail</td><td class='searchFilter'>College Profile </td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].facultyName == null){
                                ...
                                if( data[key].collegemasterId == null){
                                    ...
                                    courseDetailsText = "<a class='' href='{!! URL::to('employee/collegemaster/"+ data[key].collegemasterId +"/') !!}' >"+ functionalAreaText +' / '+ degreeDataText +' / '+ courseDataText + "</a>";
                                }
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/faculty/"+ data[key].facultyId +"/') !!}' >"+ data[key].facultyId +"</a></td><td>"+ facultyNameText +"</td><td>"+ facultyDescriptionText +"</td><td>"+ courseDetailsText +"</td><td><a href='{!! URL::to('employee/collegeprofile/"+ data[key].collegeprofileId +"/') !!}' >"+ data[key].firstname + "</a></td> <td>"+ lastUpdatedBy +" </td> <td><a href='{!! URL::to('employee/faculty/"+ data[key].facultyId +"/edit/') !!}' class='btn btn-primary btn-xs'>Update</a>/<a href='{!! URL::to('employee/faculty/"+ data[key].facultyId +"') !!}' class='btn btn-info btn-xs'>Show</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-college-faculty') }}",
