...
<!-- <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Education Level Details <a href="{{ url('employee/educationlevel/create') }}" class="btn btn-primary pull-right btn-sm">Add New Education Level</a></h2>
    </div>
</div> -->
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-educationlevel', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">      
                                            <a href="{{ URL::to('employee/educationlevel') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($educationlevel as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/educationlevel', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/educationlevel', $item->id) }}">{{ $item->name }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    @if($storeEditUpdateAction == '1')
                                    <td>
                                        <a href="{{ url('employee/educationlevel/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a><!--  /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['employee/educationlevel', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.educationLevelSearchDataObj, function (key, item) {
                                ...
                                if( data.educationLevelSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('employee/users/"+ data.educationLevelSearchDataObj[key].eUserId +"/') !!}' >"+ data.educationLevelSearchDataObj[key].employeeFirstname+' '+data.educationLevelSearchDataObj[key].employeeMiddlename+' '+data.educationLevelSearchDataObj[key].employeeLastname+' (User Id:- '+data.educationLevelSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.educationLevelSearchDataObj[key].updated_at +"</a>";
                                }

                                 

                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/educationlevel/"+ data.educationLevelSearchDataObj[key].educationlevelId +"/') !!}' >"+ data.educationLevelSearchDataObj[key].educationlevelId +"</a></td><td><a href='{!! URL::to('employee/educationlevel/"+ data.educationLevelSearchDataObj[key].educationlevelId +"/') !!}' >"+ educationLevelDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/educationlevel/"+ data.educationLevelSearchDataObj[key].educationlevelId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-educationlevel') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Education Level Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-educationlevel') }}",
