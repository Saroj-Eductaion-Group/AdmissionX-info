...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Career <!-- <a href="{{ URL::to('employee/career') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($career, ['method' => 'PATCH','url' => ['employee/career', $career->id],'class' => 'form-horizontal', 'data-parsley-validate' => '','files'=>true, 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('phonenumber', null, ['class' => 'form-control', 'placeholder' => 'Enter phone number here', 'data-parsley-error-message' => 'Please enter phone number here', 'data-parsley-trigger'=>'change','required'=>'' ]) !!}<!-- , 'data-parsley-pattern'=>'^[7-9][0-9]{9}$', 'data-parsley-maxlength'=>'10' ,'maxlength'=>'10' -->
                </div>
            </div>
            <div class="form-group">
