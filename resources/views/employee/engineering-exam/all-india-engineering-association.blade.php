            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        <form action="/employee/all-india-engineer-association" method="GET" class="form-horizontal" data-parsley-validate>
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="row">                              
                                        <div class="col-md-12 text-right">      
                                            <a href="{{ URL::to('/employee/all-india-engineer-association') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($engineeringexam as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('employee/engineering-exam', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('employee/engineering-exam', $item->id) }}">{{ $item->applicationId }}</a></td>
                                    <td><a href="{{ url('employee/engineering-exam', $item->id) }}">{{ $item->title }} {{ $item->firstname }} {{ $item->middlename }} {{ $item->lastname }}</a></td>
                                    <td>{{ $item->email }} </td>
                                    <td>{{ $item->phone }} </td>
                                    <td>{{ $item->category }} </td>
                                    <td>{{ $item->gender }} </td>
                                    ...
                                    <td>
                                        <a href="{{ url('employee/engineering-exam/' . $item->id ) }}">
