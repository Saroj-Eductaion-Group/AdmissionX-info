...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Query Details <!-- <a href="{{ url('employee/query-bya') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ URL::to('employee/query-reply-bya') }}" method="POST" data-parsley-validate>
                                <div class="row">
                                    <div class="col-md-12">
