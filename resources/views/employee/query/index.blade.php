            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/employee-query', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12 text-right">      
                                        <a href="{{ URL::to('employee/query') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($query as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ URL('/employee/query', $item->id) }}">{{ $item->id }}</a></td>
                                    <td>
                                        @if( $item->subject )
                                           <a href="{{ URL('/employee/query-details', [$item->chatkey, $item->id]) }}">{{ $item->subject }}</a>
                                        @else
                                           --
                                        @endif
                                    </td>
                                    <td>
                                        @if( $item->collegeprofileID )
                                          <a href="{{ url('employee/collegeprofile', $item->collegeprofileID) }}">{{ $item->U2FirstName }} {{ $item->U2LastName }}</a>
                                        @else
                                    ...
                                    <td>
                                        <!-- <a href="{{ URL('/employee/query-details', [$item->chatkey, $item->id]) }}" class="btn btn-xs btn-info">Show</a> -->
                                        <a href="{{ url('employee/query/' . $item->id . '/edit') }}">
        ...
        $(document).ready(function() {
                    ...
                    success  : function(data) {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.querySearchDataObj, function (key, item) {
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/query/"+ data.querySearchDataObj[key].queryID +"/') !!}' >"+ data.querySearchDataObj[key].queryID +"</a></td><td><a href='{!! URL::to('employee/query-details/"+ data.querySearchDataObj[key].chatkey+"/"+data.querySearchDataObj[key].queryID +"/') !!}' >"+ subjectDataText +"</a></td><td><a href='{!! URL::to('employee/collegeprofile/"+ data.querySearchDataObj[key].collegeprofileID +"/') !!}' >"+ collegeDataText +"</a></td><td><a href='{!! URL::to('employee/studentprofile/"+ data.querySearchDataObj[key].studentprofileID +"/') !!}' >"+ studentDataText +"</a></td><td>"+ chatDirectionText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/query/"+ data.querySearchDataObj[key].queryID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('employee/query/delete/"+ data.querySearchDataObj[key].queryID +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></td></tr>");
                                /*<td><a href='{!! URL::to('employee/user/"+ data.querySearchDataObj[key].U1Id +"/') !!}' >"+ adminDataText +"</a></td>*/
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/employee-all-query') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Subject</td><td class='searchFilter'>College Name</td><td class='searchFilter'>Student Name</td><td class='searchFilter'>Chat Direction</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].subject == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('employee/query/"+ data[key].queryID +"/') !!}' >"+ data[key].queryID +"</a></td><td><a href='{!! URL::to('employee/query-details/"+ data[key].chatkey+"/"+data[key].queryID +"/') !!}' >"+ subjectDataText +"</a></td><td><a href='{!! URL::to('employee/collegeprofile/"+ data[key].collegeprofileID +"/') !!}' >"+ collegeDataText +"</a></td><td><a href='{!! URL::to('employee/studentprofile/"+ data[key].studentprofileID +"/') !!}' >"+ studentDataText +"</a></td><td>"+ chatDirectionText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('employee/query/"+ data[key].queryID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('employee/query/delete/"+ data[key].queryID +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                                /*<td><a href='{!! URL::to('employee/user/"+ data[key].U1Id +"/') !!}' >"+ adminDataText +"</a></td>*/
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/employee-query') }}",
