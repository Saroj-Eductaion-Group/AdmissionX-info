...
Lists of Questions has been submitted on your behalf
@endsection
					...
					<div class="profile-bio">
						<div class="row">
							<div class="col-md-9">
								...
								@endif
								<span><strong>Questions has been submitted on your behalf</strong></span>
							</div>				
						</div>
					</div>
					<hr class="hr-gap">
					<div class="detail-page-signup margin-bottom40 table-responsive">
						<div class="headline"><h2>Here is the list of questions submitted by you</h2></div>
						<!-- Updated Course List -->
						@if( sizeof($listOfSubmitQuestion) > 0 )
							@foreach( $listOfSubmitQuestion as $item )
							...
							<div class="row indexPagination">
                                ...
                                <div class="custom-pagination">{!! $listOfSubmitQuestion->render() !!}</div>
	                            </div>
	                        </div>
						@else
