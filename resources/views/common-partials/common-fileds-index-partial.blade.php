<div class="checkbox checkbox-primary">
    ...
    <label>
        @if($item->isShowOnHome == 1)
            <span class="label label-info isShowOnHomeEnabled{{ $item->id }}">Is Show On Home Page Enable</span>
        @else
            <span class="label label-danger isShowOnHomeDisabled{{ $item->id }}">Is Show On Home Page Disabled</span>
        @endif
        <span class="label label-info hide isShowOnHomeEnabled1{{ $item->id }}">Is Show On Home Page Enable</span>
        <span class="label label-danger hide isShowOnHomeDisabled1{{ $item->id }}">Is Show On Home Page Disabled</span>
    </label>
</div>
