	...
	<div class="container cooming-soon-content valign__middle">
		...
		<div class="row">
			<div class="col-md-12 coming-soon">
				...
				<h2 class="test-info">Thank you for registering with <br><span class="color-green">AdmissionX</span></h2><br>
				<h3 class="test-info1">Please confirm your email and then continue to login</h3><br>
				<a href="{{ URL::to('/educational-institution') }}" class="btn-u" title="Take me to login">Take me to login</a><br>
