<div class="profile-edit tab-pane fade in active margin-top30 white-popup">
	<div class="detail-page-signup">
		<!-- <h2 class="heading-md text-center text-green"><a class="hover-effect" href="">Manage your gallery captions details</a></h2> -->
		<hr>
		<form method="POST" action="/college-affiliation-caption-update" data-parsley-validate>
			<input type="hidden" name="galleryId" value="{{ $galleryId }}">
			<input type="hidden" name="slugUrl" value="{{ $slugUrl }}">
			<div class="row padding-top5 padding-bottom5">
		    	<div class="col-md-12">
		            <textarea class="form-control" name="caption" rows="4" maxlength="120" data-parsley-error-message = "Please enter the  caption not more than 120 characters" data-parsley-trigger="change" id="counttextarea">{{ $oldCaption }}</textarea>
