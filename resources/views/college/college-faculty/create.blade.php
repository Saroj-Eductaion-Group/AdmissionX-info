		...
		<div class="row">
			...
			<div class="profile-body">					
				<div class="profile-bio">
					<div class="row">
						<div class="col-md-12">
							...
							<span><i class="fa fa-user"></i> <strong>Add New Faculty Member</strong></span>
						</div>				
				...
				<div class="bg-color-white padding20">
					<form method="POST" action="{{ URL::to('college/faculty/'.$slug.'/store') }}" data-parsley-validate="" enctype="multipart/form-data">
