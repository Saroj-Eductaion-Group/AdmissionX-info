...
<body class="header-fixed">
	...
	<div class="interactive-slider-v2 lesspadding100">
		<div class="container">
			...
			<p class="hide">Making higher education accessible, just a click away!</p>
			...
			<div class="row">
				<div class="col-md-6 shadow-wrapper">
					...
					<div class="responsive-video box-shadow shadow-effect-2">
						<!-- <iframe width="100%" src="//www.youtube.com/embed/rF-CJEbfVeI" frameborder="0" allowfullscreen></iframe> -->
				...
				<div class="col-md-6 shadow-wrapper">
					...
					<div class="responsive-video box-shadow shadow-effect-2">
						<!-- <iframe width="100%" src="//www.youtube.com/embed/aMJTDsYa428" frameborder="0" allowfullscreen></iframe> -->
												...
												<div class="margin-left10 margin-right10 margin-bottom60">
													<a href="{{ URL::to('college', $item->slug) }}" class="text-deco-none">
														@if( $item->logoImageName != '' )
															<div class="featuredCollegeBlock blog-bg-css" style="background-image: url('{{asset('gallery/')}}/{{ $item->slug }}/{{ $item->logoImageName }}');">
														@else
															<div class="featuredCollegeBlock blog-bg-css" style="background-image: url('{{asset('assets/images')}}/no-college-logo.png');">
														@endif
																	    	...
																	    	<a href="javascript:void(0);" class="bookmarkedHeartIcon">
																	    		<input type="hidden" name="bookmarkTableID" value="{{ $bookmarked->id }}">
								  												...
								  												<span title="The Featured showcase features some of the most popular colleges in each city across budgets and courses">
								  													<i class="bookmarkHeart rounded-x icon-heart"></i></span>
									      								</a>
																			{{--*/ break /*--}}
																			@else
					...
					@foreach( $getBlogsObj as $item )
						<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 margin-bottom60">
							<a href="{{ URL::to('blogs', $item['slug']) }}" class="text-deco-none">
								@if($item['featimage'] != '')
									<div class="featuredCollegeBlock bg-update-css" style="background-image: url('/blogs/{{ $item['featimage'] }}');">
								@else
									<div class="featuredCollegeBlock bg-update-css" style="background-image: url('/blogs/default.jpg');">
								@endif
								...
								<div class="feature-blog-overlay">
									<div class="feature-desc">
										...
										{{ str_limit(strip_tags($item['description']), 90) }}
										</div>
		        	...
		        	<div class="testimonials-v6-item">
		            	<div class="g-display-table g-mb-25">
							<div class="g-display-td g-text-middle" style="max-width: 120px;">
								<img class="thumbnail" src="/testimonial/-1492688781.jpg" alt="-1492688781.jpg">
							</div>
							<input type="hidden" name="testimonialsID" value="1">
			          	...
			          	<blockquote>
						 It’s a great platform to search institutions and also reserve seats in different courses. Thumbs Up to the AdmissionX team.
			          	</blockquote>
			        </div>
			        <div class="testimonials-v6-item">
		            	<div class="g-display-table g-mb-25">
							<div class="g-display-td g-text-middle" style="max-width: 120px;">
								<img class="thumbnail" src="/testimonial/rohit-kapoor-student-1492688684.jpg" alt="rohit-kapoor-student-1492688684.jpg">
							</div>
							<input type="hidden" name="testimonialsID" value="4">
							<div class="g-display-td g-text-middle">
				          		<strong>Rohit Kapoor, Mumbai</strong>
				          		<!-- <em></em> -->
							</div>
						</div>
			          	<blockquote>
						 Finally a service to enquire about admissions and getting a decision on the application, without having to visit individual college campus. Good work guys!
			          	</blockquote>
			        </div>
			        <div class="testimonials-v6-item">
		            	<div class="g-display-table g-mb-25">
							<div class="g-display-td g-text-middle" style="max-width: 120px;">
								<img class="thumbnail" src="/testimonial/-1492688544.png" alt="-1492688544.png">
							</div>
							<input type="hidden" name="testimonialsID" value="4">
							<div class="g-display-td g-text-middle">
				          		<strong>Megha Arora, Jalandhar</strong>
				          		<!-- <em></em> -->
							</div>
						</div>
			          	<blockquote>
						 Good platform to book admissions. Saved my valuable time and effort.
			          	</blockquote>
			        </div>
			        <div class="testimonials-v6-item">
		            	<div class="g-display-table g-mb-25">
							<div class="g-display-td g-text-middle" style="max-width: 120px;">
								<img class="thumbnail" src="/testimonial/-1492688381.jpg" alt="-1492688381.jpg">
							</div>
							<input type="hidden" name="testimonialsID" value="4">
							<div class="g-display-td g-text-middle">
				          		<strong>Anupam Singh, Lucknow</strong>
				          		<!-- <em></em> -->
							</div>
						</div>
			          	<blockquote>
						 “Admissionx.com” you are really a great help for admission of my daughter in 3 year’s “Fashion Designing Course”, in Mumbai. I wanted to get my daughter there but didn’t know how so easily it could be done. You have saved my time and money too. It was the best Online-support.
			          	</blockquote>
			        </div>
			        <div class="testimonials-v6-item">
		            	<div class="g-display-table g-mb-25">
							<div class="g-display-td g-text-middle" style="max-width: 120px;">
								<img class="thumbnail" src="/testimonial/-1492688193.jpg" alt="-1492688193.jpg">
							</div>
							<input type="hidden" name="testimonialsID" value="4">
							<div class="g-display-td g-text-middle">
				          		<strong>Jaspreet Kaur, Chandigarh</strong>
				          		<!-- <em></em> -->
							</div>
						</div>
			          	<blockquote>
						 Thank you so much “Admissionx.com” team. I was sick and not able to go to the College for admission. I got admission in the B-Tech course in Bengaluru city only because of you people.
			          	</blockquote>
			        </div>
			        <div class="testimonials-v6-item">
		            	<div class="g-display-table g-mb-25">
							<div class="g-display-td g-text-middle" style="max-width: 120px;">
								<img class="thumbnail" src="/testimonial/-1492689535.jpg" alt="-1492689535.jpg">
							</div>
							<input type="hidden" name="testimonialsID" value="4">
							<div class="g-display-td g-text-middle">
				          		<strong>Jyoti Sharma, Ranchi</strong>
				          		<!-- <em></em> -->
							</div>
						</div>
			          	<blockquote>
						 With the Online help of “Admissionx.com” my all worries vanished. I want to thank the team of “Admissionx.com”.
			          	</blockquote>
			        </div>
		...
		<div class="tc-testimonials-clients why-we-item dark">
			<div class="testimonials-clients-block">
		        <ul class="owl-clients-v5">
		        	<li class="testimonials-slide-style"><img src="/testimonial/-1492688781.jpg" alt="testimonial images"></li>
		        	<li class="testimonials-slide-style"><img src="/testimonial/rohit-kapoor-student-1492688684.jpg" alt="testimonial images"></li>
		        	<li class="testimonials-slide-style"><img src="/testimonial/-1492688544.png" alt="testimonial images"></li>
		        	<li class="testimonials-slide-style"><img src="/testimonial/-1492688381.jpg" alt="testimonial images"></li>
		        	<li class="testimonials-slide-style"><img src="/testimonial/-1492688193.jpg" alt="testimonial images"></li>
		        	<li class="testimonials-slide-style"><img src="/testimonial/-1492689535.jpg" alt="testimonial images"></li>
		        </ul>
			</div>
		</div>
	</div>
