...
<div class="content-md margin-bottom-30">
	<div class="container">
		...
		<form class="shopping-cart" action="/exam-payment-process-start/{{ $encryptApplicationId }}" method="POST" accept-charset="UTF-8">
			<input name="_token" type="hidden" value="{{ csrf_token() }}"/>
			<section>
				<div class="row">
				
					<div class="col-md-12">
						<h2 class="title-type">Payment details for : <span class="shop-green">{{ $studentName }}</span></h2>
						<hr>
						<h2 class="title-type">Payment information</h2>
						<ul class=" total-result"><!-- list-inline -->
							<li>
								<h4>Fee Payable To Admissionx For All India Engineering Association Exam:</h4>
								<div class="total-result-in">
									<span class="text-right">Rs. {{ $amount }}/-</span>
								</div>
							</li>
							<li><strong><h4><u>Important Dates</u></h4></strong></li>
							<li><h5>Exam Date : <b>18 June 2017</b></h5></li>
							<li><h5>Lsat Date For Application : <b>15 June 2017</b></h5></li>
							<li><h5>Admit Card to be send between : <b>16 June 2017 to 17 June 2017</b></h5></li>
						</ul>
						<hr>
						<div class="row margin-top20">
							...
							<div class="col-md-6 pull-right"><button class="btn-u pull-right rounded">Pay Now</button></div>
						</div>
					</div>
				</div>
			</section>
