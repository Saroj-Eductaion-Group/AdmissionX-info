...
<div class="single-listing-school-template single">
    ...
    <div class="featured-school">
        <div class="container">
            ...
            <form method="GET" action="/{{$getCountryDetailInfoObj->pageslug}}/college-list">
                <div class="col-md-3 sidebar-filters">
                    ...
                    <a href="{{ URL::to('/'.$getCountryDetailInfoObj->pageslug.'/college-list') }}"><button type="button" class="btn-u btn-block resetNow margin-top20 margin-bottom20">Reset</button></a>
                ...
                <div class="col-md-9">
                    <div class="slisting-search">
                        <div class="row">
                            <div class="col-md-8">
                                <input type="text" name="studyabroad" value="" class="form-control" placeholder="Search by Name - Country/State/City">
                                <div class="resultForCountryList scroll hide">
