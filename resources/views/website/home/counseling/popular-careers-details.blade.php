		...
		<div class="row">
			<div class="col-md-12">
				<div class="examsentranceBoT">
					<h2 class="text-center padding-bottom15">Popular Career Courses Details</h2>
	...
	<div class="container">
		<div class="chooseStreamTop">
			<div class="row">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="chooseWhatNext">
								<h2>Career as {{$counselingcareerdetail->title}}</h2>
							</div>
							<div class="liketweet">
								<!-- <ul>
									<li>
				...
				<div class="col-md-3">
					<div class="bExamresultRight">
						<h2>Popular Courses</h2>
						<ul>
							@foreach( $relatedPopularCareeerlist as $item )
							<li>
								<a target="_blank" href="{{ URL::to('/popular-careers/'.$item->slug) }}">
									@if(!empty($item->image))<img class="" width="30" src="/counselingimages/{{ $item->image }}" alt="{{ $item->title }}">@else <i class="fa fa-book"></i>@endif {{ str_limit($item->title, 15)}} 
