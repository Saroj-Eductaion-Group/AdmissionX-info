...
<!-- Mirrored from techjcs.com/education/top-schools.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 May 2020 01:41:12 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body class="school-listing-template">
    <div class="preloader">
                    ...
                    <div class="col-6 col-sm-9 nav-column clearfix">
                        ...
                        <nav id="menu" class="d-none d-lg-block">
                            <ul>
                                ...
                                <li><a href="{{ URL::to('top-college-page') }}">Study Abroad</a></li>
                                <li><a href="{{ URL::to('top-college-page') }}">Counseling</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="row justify-content-between">
                        ...
                        <div><span><a class="text-dark" href="{{ URL::to('/demo-new-home') }}">Home </a> > Top Schools</span></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="single-listing-box col-md-12">
                    <div class="inner d-flex">
                        ...
                        <div class="listing-content">
                            ...
                            <div class="applynow"><button>Apply Now</button> </div>
                        </div>
