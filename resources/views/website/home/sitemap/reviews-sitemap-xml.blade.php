<urlset 
    ...
    $lastmodDate= date('c');
    /*--}}
    @foreach ($listOfSubmitReviews as $blog)
        {{--*/
            $TimeStr= date('Y-m-d\TH:i:s', strtotime($blog->created_at));
        ...
        /*--}}
        <url>
            <loc>https://www.admissionx.com/college/{{strtolower($blog->collegeSlug)}}/reviews</loc>
