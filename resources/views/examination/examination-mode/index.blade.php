...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Examination mode details <a href="{{ url('examination/examination-mode/create') }}" class="btn btn-primary pull-right btn-sm">Add New Examination mode</a></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <div class="row">
                    <div class="col-lg-10">
                        <h2>Search Examination mode</h2>        
                    </div>    
                </div>

                <form action="{{ URL::to('/examination/examination-mode') }}" method="GET">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 pull-right text-right margin-top20">
                            <a href="{{ URL::to('/examination/examination-mode') }}" class="btn btn-md btn-primary">Clear</a>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
                ...
                <table class="table table-hover">
                    ...
                    <tbody class="tbody">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('examination/examination-mode/' . $item->id) }}">
                                    <button type="submit" class="btn btn-info btn-xs">Show</button>
                                </a> /
                                <a href="{{ url('examination/examination-mode/' . $item->id . '/edit') }}">
                                    <button type="submit" class="btn btn-primary btn-xs">Edit</button>
                                </a> /
                                {!! Form::open([
                                    'method'=>'DELETE',
                                    'url' => ['examination/examination-mode', $item->id],
        ...
        <div class="pagination"> {!! $examinationmode->render() !!} </div>
    </div>
</div>
@endsection
