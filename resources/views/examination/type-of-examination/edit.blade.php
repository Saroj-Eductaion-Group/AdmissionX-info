...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Edit List Of Examination  {{ $typeofexamination->id }} <a href="{{ url('examination/type-of-examination') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Update list of examination details</h5>                            
            </div>
            <div class="ibox-content">
            {!! Form::model($typeofexamination, [
                'method' => 'PATCH',
                ...
                @include ('examination.type-of-examination.form', ['submitButtonText' => 'Update'])
