    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content table-responsive">
               <div class="row">
                   <!-- <div class=""><a href="{{ url('administrator/userprivilege') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a></div> -->
               </div>
               <div class="row">
                   <div class="col-md-6">
               ...
               <div class="row">
                   ...
                   <div class="col-md-6">
                       <h4>Last Updated By : 
                            ...
                            <a href="{{ url('administrator/users', $userprivilege->eUserId) }}">{{ $userprivilege->employeeFirstname }} {{ $userprivilege->employeeMiddlename}} {{ $userprivilege->employeeLastname}} (ID:- {{ $userprivilege->eUserId}}) Date & Time:-  {{ $userprivilege->updated_at}}</a>
                            @else
