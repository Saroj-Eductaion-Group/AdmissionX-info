...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Create New User Privilege <!-- <a href="{{ url('administrator/userprivilege') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Add new user privilege details</h5>                            
            </div>
            <div class="ibox-content">
                {!! Form::open(['url' => 'administrator/userprivilege', 'class' => 'form-horizontal','data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="usersGroupId" class="form-control chosen-select" data-parsley-error-message=" Please select group name " data-parsley-trigger="change" required="">
                                <option disabled="" selected="">Select Group</option>
                                @foreach($allUserGroupObj as $item)
                                    <option value="{{ $item->id }}">{{ $item->name }} </option>
                                @endforeach
                            </select>                            
                        </div>
