...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        ...
        <a class="btn btn-primary pull-right btn-sm"  data-toggle="modal" data-target="#userPrivilegesAddTableModal" data-whatever="" href="">Add New Table</a></h2>
       <!--  <h2><a href="{{ url('administrator/userprivilege') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a></h2> -->
            ...
            <div class="ibox-content">
               <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{ url('administrator/userprivilege', $item->id) }}">{{ $item->id }}</a></td>
                            <td><a href="{{ url('administrator/userprivilege', $item->id) }}">{{ $item->tableName }}</a></td>
                            ...
                            <td>
                                <a href="{{ url('administrator/userprivilege/' . $item->id . '/edit') }}">
                                    <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                </a> /
                                {!! Form::open([
                                    'method'=>'DELETE',
                                    'url' => ['administrator/userprivilege', $item->id],
                        ...
                        <div class="modal fade" id="userPrivilegesAddTableModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="POST" action="/administrator/userprivilege/addtable" data-parsley-validate>
