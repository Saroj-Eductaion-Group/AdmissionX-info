    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
               <!-- <a href="{{ url('administrator/city') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> -->
               <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($city->eUserId)
                                <a href="{{ url('administrator/users', $city->eUserId) }}">{{ $city->employeeFirstname }} {{ $city->employeeMiddlename}} {{ $city->employeeLastname}} (ID:- {{ $city->eUserId}}) Date & Time:-  {{ $city->updated_at}}</a>
                                @else
