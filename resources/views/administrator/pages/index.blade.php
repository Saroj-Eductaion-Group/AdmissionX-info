            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/pages', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="col-md-12 text-right">      
                                        <a href="{{ URL::to('administrator/pages') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($pages as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/pages', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('administrator/pages', $item->id) }}">{{ $item->title }}</a></td>
                                    <td>
                                        @if( $item->status == '1')
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/pages/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/pages', $item->id],
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.pagesSearchDataObj, function (key, item) {
                                ...
                                if( data.pagesSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.pagesSearchDataObj[key].eUserId +"/') !!}' >"+ data.pagesSearchDataObj[key].employeeFirstname+' '+data.pagesSearchDataObj[key].employeeMiddlename+' '+data.pagesSearchDataObj[key].employeeLastname+' (User Id:- '+data.pagesSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.pagesSearchDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/pages/"+ data.pagesSearchDataObj[key].pagesId +"/') !!}' >"+ data.pagesSearchDataObj[key].pagesId +"</a></td><td><a href='{!! URL::to('administrator/pages/"+ data.pagesSearchDataObj[key].pagesId +"/') !!}' >"+ titlesDataText +"</a></td><td>"+ verifyDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/pages/"+ data.pagesSearchDataObj[key].pagesId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/pages/delete/"+ data.pagesSearchDataObj[key].pagesId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].title == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/pages/"+ data[key].pagesId +"/') !!}' >"+ data[key].pagesId +"</a></td><td><a href='{!! URL::to('administrator/pages/"+ data[key].pagesId +"/') !!}' >"+ titlesDataText +"</a></td><td>"+ verifyDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/pages/"+ data[key].pagesId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/pages/delete/"+ data[key].pagesId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                            });
