...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>User Group Details <a href="{{ url('administrator/usergroup/create') }}" class="btn btn-primary pull-right btn-sm">Add New User Group</a></h2>
    </div>
</div>
               ...
               <div class="row">
                   ...
                   <div class="col-md-4">
                       <h4>Last Updated By :-
                        ...
                        <a href="{{ url('administrator/users', $usergroup->eUserId) }}">{{ $usergroup->employeeFirstname }} {{ $usergroup->employeeMiddlename}} {{ $usergroup->employeeLastname}} (ID:- {{ $usergroup->eUserId}}) Date & Time:-  {{ $usergroup->updated_at}}</a>
                        @else
