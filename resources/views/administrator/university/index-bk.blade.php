            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/university', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">      
                                            <a href="{{ URL::to('administrator/university') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($university as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/university', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('administrator/university', $item->id) }}">{{ $item->name }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/university/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/university', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.universitySearchDataObj, function (key, item) {
                                ...
                                if( data.universitySearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.universitySearchDataObj[key].eUserId +"/') !!}' >"+ data.universitySearchDataObj[key].employeeFirstname+' '+data.universitySearchDataObj[key].employeeMiddlename+' '+data.universitySearchDataObj[key].employeeLastname+' (User Id:- '+data.universitySearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.universitySearchDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/university/"+ data.universitySearchDataObj[key].universityId +"/') !!}' >"+ data.universitySearchDataObj[key].universityId +"</a></td><td><a href='{!! URL::to('administrator/university/"+ data.universitySearchDataObj[key].universityId +"/') !!}' >"+ universityNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/university/"+ data.universitySearchDataObj[key].universityId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/university/delete/"+ data.universitySearchDataObj[key].universityId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-university') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>University Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].name == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/university/"+ data[key].universityId +"/') !!}' >"+ data[key].universityId +"</a></td><td><a href='{!! URL::to('administrator/university/"+ data[key].universityId +"/') !!}' >"+ universityNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/university/"+ data[key].universityId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/university/delete/"+ data[key].universityId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                            });
