...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Create New Slider <a href="{{ url($fetchDataServiceController->routeCall().'/slider-manager') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Add new Slider details</h5>                            
            </div>
            <div class="ibox-content">
            {!! Form::open(['url' => $fetchDataServiceController->routeCall().'/slider-manager', 'class' => 'form-horizontal','data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
            @include ('administrator.slider-manager.form')
    ...
    $("form").submit( function( e ) {
        ...
        if( file ) {
            ...
            img.onload = function() {
                ...
                // if( width >= 1400 && height >= 480 ) {
                //     form.submit();
                // }else {
                //     alert("Sorry, this image doesn\'t look like the size we wanted. It\'s  width ("+width+") height ("+height+") but we require 1400 x 480 size image.");
                // }
