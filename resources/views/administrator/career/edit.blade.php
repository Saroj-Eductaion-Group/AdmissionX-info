...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Career <!-- <a href="{{ URL::to('administrator/career') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Update career details</h5>                            
            </div>
            <div class="ibox-content">
            {!! Form::model($career, ['method' => 'PATCH','url' => ['administrator/career', $career->id],'class' => 'form-horizontal', 'data-parsley-validate' => '','files'=>true, 'enctype' => 'multipart/form-data']) !!}

            <div class="form-group">
                <label class="col-sm-2 control-label" >Name : </label>
                <div class="col-sm-10">
                    {!! Form::text('firstname', null, ['class' => 'form-control', 'placeholder' => 'Enter name here', 'data-parsley-error-message' => 'Please enter name here', 'data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
             <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('phonenumber', null, ['class' => 'form-control', 'placeholder' => 'Enter phone number here', 'data-parsley-error-message' => 'Please enter phone number here', 'data-parsley-trigger'=>'change' , 'required'=> '']) !!}
                </div><!-- ,'data-parsley-pattern' =>'^[7-9][0-9]{9}$' -->
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="gender" class="form-control chosen-select" data-placeholder="Choose sex ..." data-parsley-error-message=" Please select sex " data-parsley-trigger="change" required="">
                        ...
                        <option @if($career->gender == 'Male') selected="" @endif value="Male">Male</option>
                        <option @if($career->gender == 'Female') selected="" @endif value="Female">Female</option>
                        <option @if($career->gender == 'Other') selected="" @endif value="Other">Other</option>
                    </select>
                </div>
            </div>      
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('postappliedfor', null, ['class' => 'form-control', 'placeholder' => 'Enter post applied here', 'data-parsley-error-message' => 'Please enter your post applied', 'required' => '','data-parsley-trigger'=>'change']) !!}
            ...
            <div class="row padding-top5 padding-bottom5">
                ...
                <div class="col-md-10">
                    ...
                    <select name="stateName" class="form-control chosen-select stateName" id="stateId" data-parsley-trigger="change" data-parsley-error-message="Please select your state" required="">
