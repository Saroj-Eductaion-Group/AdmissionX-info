               ...
               <table class="table table-hover">
                    ...
                    <tbody>
                        @foreach($career as $item)
                            <tr>
                                <td><a href="{{ url('administrator/career', $item->id) }}">{{ $item->id }}</a></td>
                                <td><a href="{{ url('administrator/career', $item->id) }}">{{ $item->firstname }}</a></td>
                                ...
                                <td>
                                    <a href="{{ url('administrator/career/' . $item->id . '/edit') }}">
                                        <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                    </a> /
                                    {!! Form::open([
                                        'method'=>'DELETE',
                                        'url' => ['administrator/career', $item->id],
