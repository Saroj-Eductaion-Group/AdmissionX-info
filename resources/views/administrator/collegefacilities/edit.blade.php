...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update College Facilities <!-- <a href="{{ url('administrator/collegefacilities') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($collegefacility, [
                'method' => 'PATCH',
                'url' => ['administrator/collegefacilities', $collegefacility->id],
