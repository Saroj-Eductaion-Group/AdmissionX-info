            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/query-admissionx', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12 text-right">      
                                        <a href="{{ URL::to('administrator/query-bya') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($query as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/query-bya-detail', [$item->id, $item->queryflowtype]) }}">{{ $item->id }}</a></td>
                                    <td>
                                        @if( $item->subject )
                                           <a href="{{ url('administrator/query-bya-detail', [$item->id, $item->queryflowtype]) }}">{{ $item->subject }}
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('administrator/query-bya-detail', [$item->id, $item->queryflowtype]) }}">
        ...
        $(document).ready(function() {
                    ...
                    success  : function(data) {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.querySearchDataObj, function (key, item) {
                                ...
                                if( data.querySearchDataObj[key].queryflowtype == 'guest-to-admin' ){
                                    conditionalBody = "<a href='{!! URL::to('administrator/query/delete/"+ data.querySearchDataObj[key].queryID +"') !!}' class='btn btn-danger btn-xs'>Delete</a>";
                                }else{
                                    conditionalBody = "<a href='{!! URL::to('administrator/query-bya-detail/"+ data.querySearchDataObj[key].queryID+"/"+ data.querySearchDataObj[key].queryflowtype +"/') !!}' class='btn btn-primary btn-xs'>Reply</a>/<a href='{!! URL::to('administrator/query/delete/"+ data.querySearchDataObj[key].queryID +"') !!}' class='btn btn-danger btn-xs'>Delete</a>";
                                }
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/query/"+ data.querySearchDataObj[key].queryID +"/') !!}' >"+ data.querySearchDataObj[key].queryID +"</a></td><td><a href='{!! URL::to('administrator/query-bya-detail/"+ data.querySearchDataObj[key].queryID+"/"+ data.querySearchDataObj[key].queryflowtype +"/') !!}' >"+ subjectDataText +"</a></td><td>"+ messageDataText +"</td><td>"+ userNameDataText +"</td><td>"+ chatDirectionText +"</td><td>"+ lastUpdatedBy +" </td><td>"+conditionalBody+"</td></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-query-admissionx') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Subject</td><td class='searchFilter'>Message</td><td class='searchFilter'>User Name</td><td class='searchFilter'>Chat Direction</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].subject == ''){
                                ...
                                if( data[key].queryflowtype == 'guest-to-admin' ){
                                    conditionalBody = "<a href='{!! URL::to('administrator/query/delete/"+ data[key].queryID +"') !!}' class='btn btn-danger btn-xs'>Delete</a>";
                                }else{
                                    conditionalBody = "<a href='{!! URL::to('administrator/query-bya-detail/"+ data[key].queryID+"/"+ data[key].queryflowtype +"/') !!}' class='btn btn-primary btn-xs'>Reply</a>/<a href='{!! URL::to('administrator/query/delete/"+ data[key].queryID +"') !!}' class='btn btn-danger btn-xs'>Delete</a>";
                                }
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/query/"+ data[key].queryID +"/') !!}' >"+ data[key].queryID +"</a></td><td><a href='{!! URL::to('administrator/query-bya-detail/"+ data[key].queryID+"/"+ data[key].queryflowtype +"/') !!}' >"+ subjectDataText +"</a></td><td>"+ messageDataText +"</td><td>"+ userNameDataText +"</td><td>"+ chatDirectionText +"</td><td>"+ lastUpdatedBy +" </td><td>"+conditionalBody+"</td></td></tr>");
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/query-admissionx') }}",
