...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update College Profile <!-- <a href="{{ url('administrator/collegeprofile') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($collegeprofile, [
                'method' => 'PATCH',
                'url' => ['administrator/collegeprofile', $collegeprofile->id],
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('contactpersonnumber', null, ['class' => 'form-control', 'placeholder' => 'Enter contact person phone here', 'data-parsley-error-message' => 'Please enter valid mobile number of 10 digits', 'data-parsley-trigger'=>'change', 'data-parsley-type' =>'digits']) !!}<!-- , 'data-parsley-length'=>'[7, 11]','data-parsley-pattern'=>'^[7-9][0-9]{9}$' -->
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" >Review : </label>
                <div class="col-sm-10">
                    <select name="review" class="form-control"  data-parsley-error-message=" Please select review " data-parsley-trigger="change" >
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="agreement" class="form-control"  data-parsley-error-message=" Please select agreement " data-parsley-trigger="change" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="verified" class="form-control"  data-parsley-error-message=" Please select verified " data-parsley-trigger="change" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="advertisement" class="form-control" data-parsley-error-message=" Please select advertisement status " data-parsley-trigger="change" >
