...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>College Profile Details <!-- <a href="{{ url('administrator/collegeprofile/create') }}" class="btn btn-primary pull-right btn-sm">Add New College Profile</a> --></h2>
    </div>
</div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/college-profile', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="col-md-12 text-right">      
                                        <a href="{{ URL::to('administrator/collegeprofile') }}" class="btn btn-default btn-sm">Close</a>
...
*/
                            $.each(data.collegeProfileDataObj, function (key, item) {
                                ...
                                if( data.collegeProfileDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.collegeProfileDataObj[key].eUserId +"/') !!}' >"+ data.collegeProfileDataObj[key].employeeFirstname+' '+data.collegeProfileDataObj[key].employeeMiddlename+' '+data.collegeProfileDataObj[key].employeeLastname+' (User Id:- '+data.collegeProfileDataObj[key].eUserId+') <hr> Date & Time :- '+data.collegeProfileDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/users/"+ data.collegeProfileDataObj[key].userID +"/') !!}' >"+ data.collegeProfileDataObj[key].collegeprofileID +"</a></td><td>"+ collegeCodeText +"</td><td><a href='{!! URL::to('administrator/collegeprofile/"+ data.collegeProfileDataObj[key].collegeprofileID +"/') !!}' >"+ data.collegeProfileDataObj[key].firstname +"</a></td><td>"+ universityText +"</td> <td>"+ collegeTypeText +"</td><td>"+ verifyDataText +"</td><td>"+ reviewDataText +"</td><td>"+ agreementDataText +"</td><td><a href='{!! URL::to('administrator/sendWelcomeEmail/"+ data.collegeProfileDataObj[key].collegeprofileID +"/') !!}' class='btn btn-outline btn-sm btn-primary'>Send welcome email</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/collegeprofile/"+ data.collegeProfileDataObj[key].collegeprofileID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-college-profile') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>College Id</td><td class='searchFilter'>Created Date</td><td class='searchFilter'>College Name</td><td class='searchFilter'>University</td><td class='searchFilter'>College Type </td><td class='searchFilter'>Verified</td><td class='searchFilter'>Review</td><td class='searchFilter'>Agreement</td><td class='searchFilter'>Email</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                              ...
                              $("tbody").append("<tr><td><a href='{!! URL::to('administrator/users/"+ data[key].userID +"/') !!}' >"+ data[key].collegeprofileID +"</a></td><td>"+ collegeCodeText +"</td><td><a href='{!! URL::to('administrator/collegeprofile/"+ data[key].collegeprofileID +"/') !!}' >"+ data[key].firstname +"</a></td><td>"+ universityText +"</td> <td>"+ collegeTypeText +"</td><td>"+ verifyDataText +"</td><td>"+ reviewDataText +"</td><td>"+ agreementDataText +"</td><td><a href='{!! URL::to('administrator/sendWelcomeEmail/"+ data[key].collegeprofileID +"/') !!}' class='btn btn-outline btn-sm btn-primary'>Send welcome email</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/collegeprofile/"+ data[key].collegeprofileID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/college-profile') }}",
                       ...
                       $(".thead").append("<tr><td class='searchFilter'>College Id</td><td class='searchFilter'>Created Date</td><td class='searchFilter'>College Name</td><td class='searchFilter'>University</td><td class='searchFilter'>College Type </td><td class='searchFilter'>Verified</td><td class='searchFilter'>Review</td><td class='searchFilter'>Agreement</td><td class='searchFilter'>Email</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data == 'no' ){
                            ...
                            if( data.currentNode >= 8 ){
                                ...
                                //Center 9 elements
                                var subtractCurrentNode = data.currentNode-4;
