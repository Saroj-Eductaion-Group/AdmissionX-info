            ...
            <div class="ibox-content">
               <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $item->id }}</td>
                            <td><a href="{{ url('administrator/entranceexam', $item->id) }}">{{ $item->name }}</a></td>
                            <td>
                                @if( $item->description )
                                    {{ $item->description }}
                                @else
                            ...
                            <td>
                                <a href="{{ url('administrator/entranceexam/' . $item->id . '/edit') }}">
                                    <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                </a> /
                                {!! Form::open([
                                    'method'=>'DELETE',
                                    'url' => ['administrator/entranceexam', $item->id],
