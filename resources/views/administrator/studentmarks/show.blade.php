    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
               <!-- <a href="{{ url('administrator/studentmarks') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> -->
                        ...
                        <tr>
                            ...
                            <td>
                                @if( $studentmark->userID)
                                    <a href="{{ url('administrator/users') }}/{{ $studentmark->userID }}" title="{{ $studentmark->firstname }} {{ $studentmark->lastname }}">{{ $studentmark->firstname }} {{ $studentmark->lastname }} </a> | <a href="{{ url('administrator/studentprofile') }}/{{ $studentmark->studentprofileId }}" title="{{ $studentmark->gender }}"> {{ $studentmark->gender }} </a>
                                @else
                                    <span class="label label-warning">Not Updated Yet</span>
                                @endif
                            </td>
