...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
         <h2>Gallery Details <a href="{{ url('administrator/galleries/create') }}" class="btn btn-primary pull-right btn-sm">Add New Gallery</a></h2>
    </div>
</div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/gallery', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">      
                                            <a href="{{ URL::to('administrator/galleries') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($gallery as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/galleries', $item->id) }}">{{ $item->id }}</a></td>
                                    <td>
                                        <a href="{{ url('administrator/galleries', $item->id) }}">
                                   ...
                                   <!--  <td>@if( $item->categoryName )
                                    ...
                                    <td>
                                        @if( $item->userID)
                                            <a href="{{ url('administrator/users') }}/{{ $item->userID }}" title="{{ $item->firstname }} {{ $item->lastname }}">{{ $item->firstname }} {{ $item->lastname }} </a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/galleries/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/galleries', $item->id],
                    ...
                    success  : function(data) {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.gallerySearchDataObj, function (key, item) {
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/galleries/"+ data.gallerySearchDataObj[key].galleryID +"/') !!}' >"+ data.gallerySearchDataObj[key].galleryID +"</a></td><td><a href='{!! URL::to('administrator/galleries/"+ data.gallerySearchDataObj[key].galleryID +"/') !!}' >"+ documentNameDataText +"</a></td> <td>"+ captionDataText +"</td><td><a href='{!! URL::to('administrator/user/"+ data.gallerySearchDataObj[key].userID +"/') !!}' >"+ data.gallerySearchDataObj[key].firstname +"</a></td><td><a href='{!! URL::to('administrator/galleries/"+ data.gallerySearchDataObj[key].galleryID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/galleries/delete/"+ data.gallerySearchDataObj[key].galleryID +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                       ...
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Name</td><td class='searchFilter'>Caption</td><td class='searchFilter'>User Id</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/galleries/"+ data[key].galleryID +"/') !!}' >"+ data[key].galleryID +"</a></td><td><a href='{!! URL::to('administrator/galleries/"+ data[key].galleryID +"/') !!}' >"+ documentNameDataText +"</a></td> <td>"+ captionDataText +"</td><td><a href='{!! URL::to('administrator/user/"+ data[key].userID +"/') !!}' >"+ data[key].firstname +"</a></td><td><a href='{!! URL::to('administrator/galleries/"+ data[key].galleryID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/galleries/delete/"+ data[key].galleryID +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                            });
