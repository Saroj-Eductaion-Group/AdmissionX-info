...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Address <!-- <a href="{{ URL::to('administrator/address') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($address, ['method' => 'PATCH','url' => ['administrator/address', $address->id],'class' => 'form-horizontal', 'data-parsley-validate' => '']) !!}

            <div class="form-group">
                <label class="col-sm-2 control-label" >Name : </label>
                <div class="col-sm-10">
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter address name here', 'data-parsley-error-message' => 'Please enter address name here', 'data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
             <div class="form-group">
                <label class="col-sm-2 control-label" >Address 1 : </label>
                <div class="col-sm-10">
                    {!! Form::text('address1', null, ['class' => 'form-control', 'placeholder' => 'Enter address 1 here', 'data-parsley-error-message' => 'Please enter address 1 here', 'data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
             <div class="form-group">
                <label class="col-sm-2 control-label" >Address 2 : </label>
                <div class="col-sm-10">
                    {!! Form::text('address2', null, ['class' => 'form-control', 'placeholder' => 'Enter address 2 here', 'data-parsley-error-message' => 'Please enter address 2 here','data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
             <div class="form-group">
                <label class="col-sm-2 control-label" >Landmark : </label>
                <div class="col-sm-10">
                    {!! Form::text('landmark', null, ['class' => 'form-control', 'placeholder' => 'Enter landmark here', 'data-parsley-error-message' => 'Please enter landmark here', 'data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" >Postal Code : </label>
                <div class="col-sm-10">
                    {!! Form::text('postalcode', null, ['class' => 'form-control', 'placeholder' => 'Enter postal code here', 'data-parsley-error-message' => 'Please enter postal code here', 'data-parsley-type'=>'digits', 'data-parsley-trigger' => 'change', 'data-parsley-length' => '[4, 8]', 'data-parsley-error-message'=>'Please enter valid postal code of 4 to 8 digits']) !!}
                </div>
            </div>
             <div class="form-group">
