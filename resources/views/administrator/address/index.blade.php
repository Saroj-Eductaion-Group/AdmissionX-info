            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/address', 'class' => 'form-horizontal search-form search-form', 'data-parsley-validate' => '']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right">      
                                            <a href="{{ URL::to('administrator/address') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($address as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/address', $item->id) }}">{{ $item->id }}</a></td>
                                    <td>
                                        @if( !empty($item->addressType) )
                                           <a href="{{ url('administrator/address', $item->id) }}">{{ $item->addressType }}</a>
                                        @else
                                    ...
                                    <td>
                                        @if( !empty($item->name) )
                                           <a href="{{ url('administrator/address', $item->id) }}">{{ $item->name }}</a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        @if( !empty($item->studentUserID) )
                                            <a href="{{ url('administrator/users', $item->studentUserID) }}">{{ $item->studentUserFirstName }} {{ $item->studentUserLastName }}</a>
                                        @else
                                            --
                                        @endif
                                    </td>
                                    <td>
                                        @if( !empty($item->collegeUserID) )
                                            <a href="{{ url('administrator/users', $item->collegeUserID) }}">{{ $item->collegeUserFirstName }} </a>
                                        @else
                                            --
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/address/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> <!-- /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/address', $item->id],
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.addressSearchDataObj, function (key, item) {
                                ...
                                if( data.addressSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.addressSearchDataObj[key].eUserId +"/') !!}' >"+ data.addressSearchDataObj[key].employeeFirstname+' '+data.addressSearchDataObj[key].employeeMiddlename+' '+data.addressSearchDataObj[key].employeeLastname+' (User Id:- '+data.addressSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.addressSearchDataObj[key].updated_at +"</a>";
                                }
                               
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/address/"+ data.addressSearchDataObj[key].addressId +"/') !!}' >"+ data.addressSearchDataObj[key].addressId +"</a></td><td><a href='{!! URL::to('administrator/address/"+ data.addressSearchDataObj[key].addressId +"/') !!}' >"+ addressTypeDataText +"</a></td><td>"+ addressNameDataText +"</td><td>"+ addressDataText1 +"</td> <td>"+ addressDataText2 +"</td> <td>"+ postalCodeDataText +"</td> <td>"+ cityDataText +"</td><td><a href='{!! URL::to('administrator/users/"+ data.addressSearchDataObj[key].studentUserID +"/') !!}' >"+ studentProfileDataText +"</a></td> <td><a href='{!! URL::to('administrator/users/"+ data.addressSearchDataObj[key].collegeUserID +"/') !!}' >"+ collegeProfileDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/address/"+ data.addressSearchDataObj[key].addressId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].addressType == null ){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/address/"+ data[key].addressId +"/') !!}' >"+ data[key].addressId +"</a></td><td><a href='{!! URL::to('administrator/address/"+ data[key].addressId +"/') !!}' >"+ addressTypeDataText +"</a></td><td>"+ addressNameDataText +"</td><td>"+ addressDataText1 +"</td> <td>"+ addressDataText2 +"</td> <td>"+ postalCodeDataText +"</td> <td>"+ cityDataText +"</td><td><a href='{!! URL::to('administrator/users/"+ data[key].studentUserID +"/') !!}' >"+ studentProfileDataText +"</a></td> <td><a href='{!! URL::to('administrator/users/"+ data[key].collegeUserID +"/') !!}' >"+ collegeProfileDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/address/"+ data[key].addressId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
