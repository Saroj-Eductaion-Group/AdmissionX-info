...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Blogs Details <a href="{{ url('administrator/blogs/create') }}" class="btn btn-primary pull-right btn-sm">Add New Blogs</a></h2>
    </div>
</div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/blogs', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="col-md-12 text-right">      
                                        <a href="{{ URL::to('administrator/blogs') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($blogs as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/blogs', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('administrator/blogs', $item->id) }}">{{ $item->topic }}</a></td>
                                    ...
                                    <td><a href="{{ url('administrator/users', $item->userID ) }}">{{ $item->firstname }} {{ $item->lastname }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/blogs/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/blogs', $item->id],
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.blogsSearchDataObj, function (key, item) {
                                ...
                                if( data.blogsSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.blogsSearchDataObj[key].eUserId +"/') !!}' >"+ data.blogsSearchDataObj[key].employeeFirstname+' '+data.blogsSearchDataObj[key].employeeMiddlename+' '+data.blogsSearchDataObj[key].employeeLastname+' (User Id:- '+data.blogsSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.blogsSearchDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/blogs/"+ data.blogsSearchDataObj[key].blogsId +"/') !!}' >"+ data.blogsSearchDataObj[key].blogsId +"</a></td><td><a href='{!! URL::to('administrator/blogs/"+ data.blogsSearchDataObj[key].blogsId +"/') !!}' >"+ topicsDataText +"</a></td><td>"+ verifyDataText +"</td><td><a href='{!! URL::to('administrator/user/"+ data.blogsSearchDataObj[key].userID +"/') !!}' >"+ data.blogsSearchDataObj[key].firstname +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/blogs/"+ data.blogsSearchDataObj[key].blogsId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/blogs/delete/"+ data.blogsSearchDataObj[key].blogsId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].topic == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/blogs/"+ data[key].blogsId +"/') !!}' >"+ data[key].blogsId +"</a></td><td><a href='{!! URL::to('administrator/blogs/"+ data[key].blogsId +"/') !!}' >"+ topicsDataText +"</a></td><td>"+ verifyDataText +"</td><td><a href='{!! URL::to('administrator/user/"+ data[key].userID +"/') !!}' >"+ data[key].firstname +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/blogs/"+ data[key].blogsId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/blogs/delete/"+ data[key].blogsId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                            });
