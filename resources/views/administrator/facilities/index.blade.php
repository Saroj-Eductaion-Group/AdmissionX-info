...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Facilities Details <a href="{{ url('administrator/facilities/create') }}" class="btn btn-primary pull-right btn-sm">Add New Facilities</a></h2>
    </div>
</div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/facilities', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h4 for="usr">Facilities Name<span class="pull-right"><a href="javascript:void(0);" id="refresh1" class="hide"><i class="fa fa-remove"></i></a></span></h4>
                                            <input type="text" class="form-control facilityName" name="facilityName" placeholder="Enter facilities name here" data-parsley-error-message="Please enter facilities name" data-parsley-trigger="change">
                                        </div>  
                                                                                
                                        <div class="col-md-6 text-right">      
                                            <a href="{{ URL::to('administrator/facilities') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        @if( $facilities == '0' )
                            <input type="text" class="result-zero hide" value="{{ $facilities }}">
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($facilities as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/facilities', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('administrator/facilities', $item->id) }}">{{ $item->name }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/facilities/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/facilities', $item->id],
                        ...
                        <div class="row indexPagination">
                            <div class="col-md-12">
                                <div class="pull-right custom-pagination">{!! $facilities->render() !!}</div>
                            </div>
                        </div>
                        @endif
        ...
        $(document).ready(function() {
            ...
            $('.search-form').on('submit',function(e){
                ...
                $.ajax({
                    ...
                    success  : function(data) {
                        ...
                        $(".thead").empty();
                        $(".tbody").empty();
                        $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Facilities Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.facilitySearchDataObj, function (key, item) {

                                if( data.facilitySearchDataObj[key].name == ''){
                                     facilityNameDataText = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    facilityNameDataText = data.facilitySearchDataObj[key].name;
                                }

                                if( data.facilitySearchDataObj[key].eUserId == null ){
                                    lastUpdatedBy = '<strong class="label label-warning">Not Updated</strong>';
                                }else{
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.facilitySearchDataObj[key].eUserId +"/') !!}' >"+ data.facilitySearchDataObj[key].employeeFirstname+' '+data.facilitySearchDataObj[key].employeeMiddlename+' '+data.facilitySearchDataObj[key].employeeLastname+' (User Id:- '+data.facilitySearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.facilitySearchDataObj[key].updated_at +"</a>";
                                }

                                 

                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/facilities/"+ data.facilitySearchDataObj[key].facilitiesId +"/') !!}' >"+ data.facilitySearchDataObj[key].facilitiesId +"</a></td><td><a href='{!! URL::to('administrator/facilities/"+ data.facilitySearchDataObj[key].facilitiesId +"/') !!}' >"+ facilityNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/facilities/"+ data.facilitySearchDataObj[key].facilitiesId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/facilities/delete/"+ data.facilitySearchDataObj[key].facilitiesId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                                
                            });

                            //Create html pagination desgin
                            if( data.facilitySearchDataObj1 > 1 ){
                                var HTML = '';
                                HTML +='<ul class="pagination">';
                                HTML +='<li class="active"><span class="currentCounter">1</span></li>';
                                if( data.facilitySearchDataObj1 < 8 ){
                                    for(var i=2; i <= data.facilitySearchDataObj1; i++){
                                ...
                                if( data.facilitySearchDataObj1 < 8 ){
                                    ...
                                    var lessTwo = data.facilitySearchDataObj1-1;
                                    for(var i=lessTwo; i <= data.facilitySearchDataObj1; i++){
                                        HTML +='<li><span class="currentCounter">'+ i +'</span></li>';
                                    } 
                                }
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-facilities') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Facilities Name</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].name == ''){
                                    ...
                                    facilityNameDataText = data[key].name;
                                }
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/facilities/"+ data[key].facilitiesId +"/') !!}' >"+ data[key].facilitiesId +"</a></td><td><a href='{!! URL::to('administrator/facilities/"+ data[key].facilitiesId +"/') !!}' >"+ facilityNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/facilities/"+ data[key].facilitiesId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/facilities/delete/"+ data[key].facilitiesId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/facilities') }}",
                    data     : { facilityName:facilityName, currentNode: currentNode },
                    dataType : "json",
                    success: function(data) {
                        $('.prevFilter').show();
                        $('.spiner-example').addClass('hide');
                        ...
                        if( data == 'no' ){
                            ...
                            if( data.currentNode >= 8 ){
                                ...
                                for( var adds = plusOne; adds <= addInCurrentNode; adds++ ){
                                    if( data.facilitySearchDataObj1 > adds ){
