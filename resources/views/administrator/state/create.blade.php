...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Create New State <!-- <a href="{{ url('administrator/state') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Add new state details</h5>                            
            </div>
            <div class="ibox-content">
            {!! Form::open(['url' => 'administrator/state', 'class' => 'form-horizontal', 'data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter state name here', 'data-parsley-error-message' => 'Please enter state name here','data-parsley-trigger'=>'change', 'required' => '']) !!}
                </div>
            </div>
