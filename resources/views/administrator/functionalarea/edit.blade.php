...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Stream <!-- <a href="{{ url('administrator/functionalarea') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                {!! Form::model($functionalarea, [ 'method' => 'PATCH', 'url' => ['administrator/functionalarea', $functionalarea->id], 'class' => 'form-horizontal', 'data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
                   
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Stream Name : </label>
                        <div class="col-sm-10">
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter stream name here', 'data-parsley-error-message' => 'Please enter stream name here', 'data-parsley-trigger'=>'change', 'required' => '']) !!}
                        </div>
                    </div>
