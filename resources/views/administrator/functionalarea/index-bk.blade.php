            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/functionalarea', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">      
                                            <a href="{{ URL::to('administrator/functionalarea') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($functionalarea as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/functionalarea', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('administrator/functionalarea', $item->id) }}">{{ $item->name }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/functionalarea/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/functionalarea', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.functionalAreaSearchDataObj, function (key, item) {
                                ...
                                if( data.functionalAreaSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.functionalAreaSearchDataObj[key].eUserId +"/') !!}' >"+ data.functionalAreaSearchDataObj[key].employeeFirstname+' '+data.functionalAreaSearchDataObj[key].employeeMiddlename+' '+data.functionalAreaSearchDataObj[key].employeeLastname+' (User Id:- '+data.functionalAreaSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.functionalAreaSearchDataObj[key].updated_at +"</a>";
                                }

                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/functionalarea/"+ data.functionalAreaSearchDataObj[key].functionalareaId +"/') !!}' >"+ data.functionalAreaSearchDataObj[key].functionalareaId +"</a></td><td><a href='{!! URL::to('administrator/functionalarea/"+ data.functionalAreaSearchDataObj[key].functionalareaId +"/') !!}' >"+ functionalAreaDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/functionalarea/"+ data.functionalAreaSearchDataObj[key].functionalareaId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/functionalarea/delete/"+ data.functionalAreaSearchDataObj[key].functionalareaId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-functionalarea') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Stream</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].name == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/functionalarea/"+ data[key].functionalareaId +"/') !!}' >"+ data[key].functionalareaId +"</a></td><td><a href='{!! URL::to('administrator/functionalarea/"+ data[key].functionalareaId +"/') !!}' >"+ functionalAreaDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/functionalarea/"+ data[key].functionalareaId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/functionalarea/delete/"+ data[key].functionalareaId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/functionalarea') }}",
