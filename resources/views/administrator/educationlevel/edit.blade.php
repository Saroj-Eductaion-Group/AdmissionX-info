...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Education Level <!-- <a href="{{ url('administrator/educationlevel') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                 {!! Form::model($educationlevel, [ 'method' => 'PATCH', 'url' => ['administrator/educationlevel', $educationlevel->id], 'class' => 'form-horizontal', 'data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
                 <div class="form-group">
                    <label class="col-sm-2 control-label">Education Level Name : </label>
                    <div class="col-sm-10">
                        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter education level here', 'data-parsley-error-message' => 'Please enter education level here', 'data-parsley-trigger'=>'change', 'required' => '']) !!}
                    </div>
                </div>
