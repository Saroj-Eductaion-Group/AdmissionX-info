            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        {!! Form::open(['url' => 'administrator/search-transaction-analytics', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
...
<script type="text/javascript">
    $(function() {
        ...
        if( transactionAnalytics != '0' ){
            $('.analytic-box-content').removeClass('hide');
            Morris.Line({
            ...
            $('.analytic-box-content').addClass('hide');
