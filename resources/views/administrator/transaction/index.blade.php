...
<!-- <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
         <h2>Transaction Details <a href="{{ url('administrator/transaction/create') }}" class="btn btn-primary pull-right btn-sm">Add New Transaction</a></h2>
    </div>
</div> -->
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/transaction', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12 text-right">      
                                        <a href="{{ URL::to('administrator/transaction') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class="table-responsive"> 
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($transaction as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/transaction', $item->id) }}">{{ $item->id }}</a></td>
                                    <td><a href="{{ url('administrator/transaction', $item->id) }}">{{ $item->firstname }} {{ $item->middlename }} {{ $item->lastname }}</a></td>
                                    <td><a href="{{ url('administrator/application', $item->applicationId) }}">{{ $item->applicationID }}</a></td>
                                    ...
                                    <!-- <td>
                                        <a href="{{ url('administrator/transaction/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> --> <!-- /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/transaction', $item->id],
        ...
        $(document).ready(function() {
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-transaction') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Name</td><td class='searchFilter'>Application No</td><td class='searchFilter'>Transaction Date</td><td class='searchFilter'>Total Fee</td><td class='searchFilter'>Paid Amount</td><td class='searchFilter'>Rest Amount</td><td class='searchFilter'>Card Type</td><td class='searchFilter'>Payment Status</td><td class='searchFilter'>Last Updated By</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].firstname == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/transaction/"+ data[key].transactionID +"/') !!}' >"+ data[key].transactionID +"</a></td><td><a href='{!! URL::to('administrator/transaction/"+ data[key].transactionID +"/') !!}' >"+ transactionNameDataText +"</a></td><td><a href='{!! URL::to('administrator/application/"+ data[key].applicationId +"/') !!}' >"+ applicationNameDataText +"</a></td><td>"+ transcationDate +"</td><td>"+ totalfee +"</td><td>"+ paidamount +"</td><td>"+ restamount +"</td><td>"+ cardTypeDataText +"</td><td>"+ paymentStatusDataText +"</td><td>"+ lastUpdatedBy +" </td></tr>");
                            });


                            /*<td><a href='{!! URL::to('administrator/transaction/"+ data[key].transactionID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td>*/
