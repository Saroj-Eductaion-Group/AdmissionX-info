            ...
            <div class="ibox-content">
               <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{ url('administrator/addresstype', $item->id) }}">{{ $item->id }}</a></td>
                            <td><a href="{{ url('administrator/addresstype', $item->id) }}">{{ $item->name }}</a></td>
                            <td>
                                @if($item->eUserId)
                            ...
                            <td>
                                <a href="{{ url('administrator/addresstype/' . $item->id . '/edit') }}">
                                    <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                </a> <!-- /
                                {!! Form::open([
                                    'method'=>'DELETE',
                                    'url' => ['administrator/addresstype', $item->id],
