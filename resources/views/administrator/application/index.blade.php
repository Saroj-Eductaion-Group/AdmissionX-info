            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/application', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="hr-line-dashed"></div>
                                    <div class="col-md-12 text-right">      
                                        <a href="{{ URL::to('administrator/application') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class="table-responsive"> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($application as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/application', $item->id) }}">{{ $item->applicationID }}</a></td>
                                    <td>
                                        @if($item->created_at)
                                    ...
                                    <td>
                                        @if( $item->applicationFirstName )
                                           <a href="{{ url('administrator/application', $item->id) }}">{{ $item->applicationFirstName }} {{ $item->applicationMiddleName }} {{ $item->applicationLastname }}</a>
                                        @else
                                            <span class="label label-warning">Not Updated Yet</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('administrator/collegemaster', $item->collegemasterId) }}">
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/application/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> <!-- /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/application', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.applicationSearchDataObj, function (key, item) {
                               ...
                               if( data.applicationSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.applicationSearchDataObj[key].eUserId +"/') !!}' >"+ data.applicationSearchDataObj[key].employeeFirstname+' '+data.applicationSearchDataObj[key].employeeMiddlename+' '+data.applicationSearchDataObj[key].employeeLastname+' (User Id:- '+data.applicationSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.applicationSearchDataObj[key].updated_at +"</a>";
                                }     

                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/application/"+ data.applicationSearchDataObj[key].applicationId +"/') !!}' >"+ data.applicationSearchDataObj[key].applicationID +"</a></td><td>"+ applicationDateDataText +"</td><td><a href='{!! URL::to('administrator/users/"+ data.applicationSearchDataObj[key].studentUserID +"/') !!}' >"+ usernameDataText +"</a></td><td>"+ applicationStatusDataText +"</td><td>"+ dobDataText +"</td><td>"+ emailAddressDataText +"</td><td>"+ phoneDataText +"</td><td>"+ genderDataText +"</td><td><a href='{!! URL::to('administrator/collegeprofile/"+ data.applicationSearchDataObj[key].collegeprofileID +"/') !!}' >"+ collegeProfileDataText +"</a></td><td><a href='{!! URL::to('administrator/collegemaster/"+ data.applicationSearchDataObj[key].collegemasterId +"/') !!}' >"+ courseNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/application/"+ data.applicationSearchDataObj[key].applicationId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-application') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><th class='searchFilter'>Application Date</th><td class='searchFilter'>Student Name</td><td class='searchFilter'>Application Status</td><td class='searchFilter'>D.O.B</td><td class='searchFilter'>Email</td><td class='searchFilter'>Phone</td><td class='searchFilter'>Gender</td><td class='searchFilter'>College Profile</td><td class='searchFilter'>Course</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].collegeUserID == null){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/application/"+ data[key].applicationId +"/') !!}' >"+ data[key].applicationID +"</a></td><td>"+ applicationDateDataText +"</td><td><a href='{!! URL::to('administrator/users/"+ data[key].studentUserID +"/') !!}' >"+ usernameDataText +"</a></td><td>"+ applicationStatusDataText +"</td><td>"+ dobDataText +"</td><td>"+ emailAddressDataText +"</td><td>"+ phoneDataText +"</td><td>"+ genderDataText +"</td><td><a href='{!! URL::to('administrator/collegeprofile/"+ data[key].collegeprofileID +"/') !!}' >"+ collegeProfileDataText +"</a></td><td><a href='{!! URL::to('administrator/collegemaster/"+ data[key].collegemasterId +"/') !!}' >"+ courseNameDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/application/"+ data[key].applicationId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
