...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update College Course <!-- <a href="{{ url('administrator/collegemaster') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($collegemaster, [
                'method' => 'PATCH',
                'url' => ['administrator/collegemaster', $collegemaster->id],
            ...
            <div class="row padding-top5 padding-bottom5">
                ...
                <div class="col-sm-10">
                    {!! Form::text('fees', null, ['class' => 'form-control', 'placeholder' => 'Enter total fees', 'data-parsley-error-message' => 'Please enter total fees here', 'data-parsley-type'=>'number','data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
            <div class="row padding-top5 padding-bottom5">
                <label class="col-sm-2 control-label" >Total Seats : </label>
                <div class="col-sm-10">
                    {!! Form::text('seats', null, ['class' => 'form-control', 'placeholder' => 'Enter total seats', 'data-parsley-type'=>'number','data-parsley-trigger'=>'change','data-parsley-error-message'=>'Please enter total available seats in the course of 1 to 5 digits','data-parsley-type'=>'digits','data-parsley-minlength'=>'1','data-parsley-maxlength'=>'5','maxlength'=>'5']) !!}
                </div>
            </div>
            <div class="row padding-top5 padding-bottom5">
