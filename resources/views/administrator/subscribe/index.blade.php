...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Subscriber Details <a href="{{ url('administrator/subscribe/create') }}" class="btn btn-primary pull-right btn-sm">Add New Subscribe</a></h2>
    </div>
</div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/subscribe', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">      
                                            <a href="{{ URL::to('administrator/subscribe') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($subscribe as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/subscribe', $item->id) }}">{{ $item->id }}</a></td>
                                    <td>
                                        @if($item->name)
                                            {{ $item->name}}
                                        @else
                                    ...
                                    <td><a href="{{ url('administrator/subscribe', $item->id) }}">{{ $item->email }}</a></td>
                                    <td>
                                        @if($item->eUserId)
                                    ...
                                    <td>
                                        <!-- <a href="{{ url('administrator/subscribe/' . $item->id . '/edit') }}">
                                        ...
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/subscribe', $item->id],
        ...
        $(document).ready(function() {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.subscribeSearchDataObj, function (key, item) {
                                ...
                                if( data.subscribeSearchDataObj[key].eUserId == null ){
                                    ...
                                    lastUpdatedBy = "<a class='' href='{!! URL::to('administrator/users/"+ data.subscribeSearchDataObj[key].eUserId +"/') !!}' >"+ data.subscribeSearchDataObj[key].employeeFirstname+' '+data.subscribeSearchDataObj[key].employeeMiddlename+' '+data.subscribeSearchDataObj[key].employeeLastname+' (User Id:- '+data.subscribeSearchDataObj[key].eUserId+') <hr> Date & Time :- '+data.subscribeSearchDataObj[key].updated_at +"</a>";
                                }
                                 

                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/subscribe/"+ data.subscribeSearchDataObj[key].subscribeId +"/') !!}' >"+ data.subscribeSearchDataObj[key].subscribeId +"</a></td><td>"+ subscriberNameDataText +"</td><td><a href='{!! URL::to('administrator/subscribe/"+ data.subscribeSearchDataObj[key].subscribeId +"/') !!}' >"+ emailAddressDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/subscribe/"+ data.subscribeSearchDataObj[key].subscribeId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/subscribe/delete/"+ data.subscribeSearchDataObj[key].subscribeId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-subscribe') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Subscriber Name</td><td class='searchFilter'>Email Address</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if( data[key].email == ''){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/subscribe/"+ data[key].subscribeId +"/') !!}' >"+ data[key].subscribeId +"</a></td><td>"+ subscriberNameDataText +"</td><td><a href='{!! URL::to('administrator/subscribe/"+ data[key].subscribeId +"/') !!}' >"+ emailAddressDataText +"</a></td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/subscribe/"+ data[key].subscribeId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/subscribe/delete/"+ data[key].subscribeId +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
                            });
