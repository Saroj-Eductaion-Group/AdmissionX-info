...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
         <h2>Documents Details <a href="{{ url('administrator/documents/create') }}" class="btn btn-primary pull-right btn-sm">Add New Documents</a></h2>
    </div>
</div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/document', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">      
                                            <a href="{{ URL::to('administrator/documents') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($documents as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/documents', $item->id) }}">{{ $item->id }}</a></td>
                                   
                                     <td>
                                        <a href="{{ url('administrator/documents', $item->id) }}">
                                   ...
                                   <!--  <td>
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/documents/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a> /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/documents', $item->id],
        ...
        $(document).ready(function() {
                    ...
                    success  : function(data) {
                        ...
                        if( data == 'no' ){
                            ...
                            $.each(data.documentSearchDataObj, function (key, item) {
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/documents/"+ data.documentSearchDataObj[key].documentsID +"/') !!}' >"+ data.documentSearchDataObj[key].documentsID +"</a></td><td><a href='{!! URL::to('administrator/documents/"+ data.documentSearchDataObj[key].documentsID +"/') !!}' >"+ documentNameDataText +"</a></td><td><a href='{!! URL::to('administrator/user/"+ data.documentSearchDataObj[key].userID +"/') !!}' >"+ data.documentSearchDataObj[key].firstname +"</a></td><td><a href='{!! URL::to('administrator/documents/"+ data.documentSearchDataObj[key].documentsID +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a>/<a href='{!! URL::to('administrator/documents/delete/"+ data.documentSearchDataObj[key].documentsID +"') !!}' class='btn btn-danger btn-xs'>Delete</a></td></tr>");
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-document') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Name</td><td class='searchFilter'>User Name</td><td class='searchFilter'>Actions</td></tr>");
