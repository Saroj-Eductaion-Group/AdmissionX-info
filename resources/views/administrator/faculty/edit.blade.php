...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Faculty <!-- <a href="{{ url('administrator/faculty') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($faculty, ['method' => 'PATCH', 'url' => ['administrator/faculty', $faculty->id], 'class' => 'form-horizontal','data-parsley-validate' => '', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="suffix">
                        ...
                        @if( $faculty->suffix )
                            <option value="{{ $faculty->suffix }}" selected="">{{ $faculty->suffix }}</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter name here', 'data-parsley-error-message' => 'Please enter entrance exam name here', 'data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
            <div class="form-group">
