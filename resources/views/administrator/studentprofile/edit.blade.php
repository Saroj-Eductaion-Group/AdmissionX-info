...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Student Profile <!-- <a href="{{ url('administrator/studentprofile') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($studentprofile, [
                'method' => 'PATCH',
                'url' => ['administrator/studentprofile', $studentprofile->id],
                ...
                <div class="form-group">
                    ...
                    @if($studentDataObj)
                        @foreach(  $studentDataObj as  $studentData )
                            ...
                            {{--*/ $studentProfileIcon = $studentData->galleryFullImage  /*--}}
                            {{--*/ $studentSlug = $studentData->slug  /*--}}
                        @endforeach
                    @endif
                    <div class="col-sm-8">
                    ...
                    <div class="col-sm-4">
                        @if($studentProfileIcon != '')
                            <img class="img-responsive img-thumbnail" src="{{asset('gallery/')}}/{{ $studentSlug }}/{{ $studentProfileIcon }}">
                        @else
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        {!! Form::text('parentsnumber', null, ['class' => 'form-control', 'placeholder' => 'Enter parent phone number here', 'data-parsley-error-message' => 'Please enter your parent valid phone number', 'data-parsley-trigger'=>'change']) !!}
                        ...
                        <label>10th Marks</label>
                         @if( $getStudent10thmarksObj )
                            @foreach(  $getStudent10thmarksObj as  $student10thMarksData )
                                ...
                                <input type="text" class="form-control" name="tenthMarks" value="{{ $student10thMarksData->marks }}" placeholder="Please enter 10th mark here" data-parsley-length="[2, 4]" data-parsley-trigger="change" data-parsley-error-message="Please enter 10th mark here" data-parsley-type="number" >
                                @endif
                            @endforeach
                        @else
                            <input type="text" class="form-control" name="tenthMarks" placeholder="Please enter 10th mark here" data-parsley-trigger="change" data-parsley-length="[2, 4]" data-parsley-type="number"  data-parsley-error-message="Please enter 10th mark here">
                        @endif
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        @if( $getStudent11thmarksObj )
                            @foreach(  $getStudent11thmarksObj as $student11thMarksData )
                                ...
                                <input type="text" class="form-control" name="eleventhmarks" value="{{ $student11thMarksData->marks }}" placeholder="Please enter 11th mark here" data-parsley-length="[2, 4]" data-parsley-trigger="change" data-parsley-error-message="Please enter 11th mark here" data-parsley-type="number">
                                @endif
                            @endforeach
                        @else
                            <input type="text" class="form-control" name="eleventhmarks" placeholder="Please enter 11th mark here" data-parsley-trigger="change" data-parsley-length="[2, 4]" data-parsley-error-message="Please enter 11th mark here" data-parsley-type="number" >
                        @endif
                    </div>
                    <div class="col-md-4">
                        ...
                        <label>12th Marks</label>
                         @if( $getStudent12thmarksObj )
                            @foreach( $getStudent12thmarksObj as  $student12thMarksData )
                                ...
                                <input type="text" class="form-control" name="twelvemarks" value="{{ $student12thMarksData->marks }}" placeholder="Please enter 12th mark here" data-parsley-length="[2, 4]" data-parsley-trigger="change" data-parsley-error-message="Please enter 12th mark here"  data-parsley-type="number" >
                                
                                @endif
                            @endforeach
                        @else
                            <input type="text" class="form-control" name="twelvemarks" placeholder="Please enter 12th mark here" data-parsley-trigger="change" data-parsley-length="[2, 4]" data-parsley-error-message="Please enter 12th mark here" data-parsley-type="number" >
                        @endif
                    </div>
                     <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label>Entrance Exam No./Rank/Percentage</label>
                        {!! Form::text('entranceexamnumber', null, ['class' => 'form-control', 'placeholder' => 'Enter entrance exam number here', 'data-parsley-error-message' => 'Please enter your entrance exam number','data-parsley-trigger'=>'change']) !!}
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="row">
        ...
        <div class="ibox float-e-margins">
                ...
                <div class="col-sm-10">
                    <select name="gender" class="form-control chosen-select" value="{{ $studentprofile->gender }}" data-placeholder="Choose sex ..."  data-parsley-error-message=" Please select sex " data-parsley-trigger="change" required="">
                        <option value=""  selected disabled>Select Sex</option>
                            ...
                            @else( $studentprofile->gender == 'Female')
           ...
           <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('hobbies', null, ['class' => 'form-control', 'placeholder' => 'Enter hobbies here', 'data-parsley-error-message' => 'Please enter your hobbies', 'required' => '','data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
             <div class="form-group">
                <label class="col-sm-2 control-label" >Interest : </label>
                <div class="col-sm-10">
                    {!! Form::text('interests', null, ['class' => 'form-control', 'placeholder' => 'Enter interests here', 'data-parsley-error-message' => 'Please enter your interests', 'required' => '','data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" >Entrance Exam Name : </label>
                <div class="col-sm-10">
                    {!! Form::text('entranceexamname', null, ['class' => 'form-control', 'placeholder' => 'Enter entrance exam name here', 'data-parsley-error-message' => 'Please enter your entrance exam name', 'required' => '','data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                     {!! Form::textarea('achievementsawards', null, ['class' => 'form-control', 'placeholder' => 'Enter achievement awards here', 'data-parsley-error-message' => 'Please enter your achievement awards', 'required' => '','data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::textarea('projects', null, ['class' => 'form-control', 'placeholder' => 'Enter projects here', 'data-parsley-error-message' => 'Please enter your projects', 'required' => '','data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
