            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="slideDown" style="visibility:hidden">
                        ...
                        {!! Form::open(['url' => 'search/student-profile', 'class' => 'form-horizontal search-form', 'data-parsley-validate'=>'data-parsley-validate']) !!}
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right">      
                                            <a href="{{ URL::to('administrator/studentprofile') }}" class="btn btn-default btn-sm">Close</a>
                    ...
                    <div class=""> <!-- table-responsive -->
                        ...
                        <table class="table table-bordered" >
                            ...
                            @foreach($studentprofile as $item)
                                <tr class="gradeX">
                                    <td><a href="{{ url('administrator/studentprofile', $item->id) }}">{{ $item->id }}</a></td>
                                    <td>
                                        @if( $item->userID)
                                            <a href="{{ url('administrator/users', $item->userID) }}">{{ $item->firstname }} {{ $item->middlename }} {{ $item->lastname }}</a>
                                        @else 
                                   ...
                                   <!--  <td>
                                    ...
                                    <td>
                                        <a href="{{ url('administrator/studentprofile/' . $item->id . '/edit') }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Update</button>
                                        </a>/
                                        <a href="{{ url('administrator/studentprofile/' . $item->id) }}">
                                            <button type="submit" class="btn btn-primary btn-xs">Show</button>
                                        </a> <!-- /
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['administrator/studentprofile', $item->id],
        ...
        $(document).ready(function() {
            ...
            $('.resetfilter').on('click',function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "{{ URL::to('search/all-student-profile') }}",
                    success  : function(data) {
                        $(".thead").empty();
                        $(".tbody").empty();
                       $(".thead").append("<tr><td class='searchFilter'>Id</td><td class='searchFilter'>Student Name</td><td class='searchFilter'>Created Date</td><td class='searchFilter'>Phone No</td><td class='searchFilter'>Email Address </td><td class='searchFilter'>Gender</td><td class='searchFilter'>D.O.B</td><td class='searchFilter'>Last Updated By</td><td class='searchFilter'>Actions</td></tr>");
                        ...
                        if( data.length == '' ){
                            ...
                            $.each(data, function (key, item) {
                               ...
                               if(data[key].dateofbirth == '0000-00-00' ){
                                ...
                                $("tbody").append("<tr><td><a href='{!! URL::to('administrator/user/"+ data[key].userID +"/') !!}' >"+ data[key].studentprofileId +"</a></td><td><a href='{!! URL::to('administrator/studentprofile/"+ data[key].studentprofileId +"/') !!}' >"+ studentNameDataText +"</a></td><td>"+ parentsNameDataText +"</td><td>"+ userPhoneText +"</td> <td>"+ userEmailAddressText +"</td><td>"+ genderDataText +"</td><td>"+ studentDOBDataText +"</td><td>"+ lastUpdatedBy +" </td><td><a href='{!! URL::to('administrator/studentprofile/"+ data[key].studentprofileId +"/edit/') !!}' class='btn btn-primary btn-xs'>update</a></td></tr>");
                            });
    ...
    <script type="text/javascript">
        $(document).on('click','.pagination > li > .currentCounter',function(){
            ...
            $.ajax({
                    ...
                    type     : "POST",
                    cache    : false,
                    url      : "{{ URL::to('search/student-profile') }}",
