...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>Update Testimonial <!-- <a href="{{ url('administrator/testimonial') }}" class="btn btn-warning pull-right btn-sm"><i class="fa fa-arrow-left"></i> Back</a> --></h2>
    </div>
</div>
...
<div class="row wrapper border-bottom page-heading margin-top20">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            {!! Form::model($testimonial, ['method' => 'PATCH', 'url' => ['administrator/testimonial', $testimonial->id], 'class' => 'form-horizontal', 'data-parsley-validate' => '','files'=>true, 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('author', null, ['class' => 'form-control', 'placeholder' => 'Enter author here', 'data-parsley-error-message' => 'Please enter author here', 'data-parsley-trigger'=>'change']) !!}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span class="pull-right text-danger"><a href="javascript:void(0);" id="refresh2" class="hide"><i class="fa fa-remove"></i></a> </span>
                     <input type="file" name="uploadTestimonialDoc" class="uploadTestimonialDoc form-control" data-parsley-filemaxmegabytes="2" data-parsley-trigger="change" data-parsley-filemimetypes="image/jpeg, image/jpg, image/png" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::text('description', null, ['class' => 'form-control', 'placeholder' => 'Enter description here', 'data-parsley-error-message' => 'Please enter description here maximum 350 character', 'data-parsley-trigger'=>'change','data-parsley-maxlength'=>'350','maxlength'=>'350']) !!}
                </div>
            </div>
