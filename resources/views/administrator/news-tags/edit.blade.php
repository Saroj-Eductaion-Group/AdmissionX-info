...
<div class="row  border-bottom white-bg dashboard-header">
    ...
    <div class="col-lg-1">
        <a href="{{ url($fetchDataServiceController->routeCall().'/news-tags/') }}" class="btn btn-warning btn-sm" title="Edit NewsType"><i class="fa fa-arrow-left"></i> Back</a>
    </div>    
    @if(Auth::check())
        @if(Auth::user()->userrole_id == 4)
            @if((isset($validateUserRoleCall)) && (sizeof($validateUserRoleCall) > 0) && ($validateUserRoleCall[0]->edit == '1'))
            <div class="col-lg-1">
                <a href="{{ url($fetchDataServiceController->routeCall().'/news-tags/' . $newstag->id . '/edit') }}" class="btn btn-primary btn-sm" title="Edit NewsType"><i class="fa fa-pencil"></i> Edit</a>
            </div>
            @endif
        @else
            <div class="col-lg-1">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                                ...
                                <input type="text" name="name" value="{{ $newstag->name }}" class="form-control" required="" data-parsley-error-message="Please enter news tags name">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
