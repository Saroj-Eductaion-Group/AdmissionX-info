...
<?php /*@extends('website/website-layouts.master')*/ ?>
@section('styles')
	...
	<div class="container content">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				{!! Form::open(['url' => 'querysearch/doLogin', 'method' => 'POST','class' => 'reg-page detail-page-signup', 'data-parsley-validate' => '']) !!}
					...
					<div class="row">
						<div class="col-md-8">
							<p>No worries, <a class="color-green" data-toggle="modal" data-target="#forgetPasswordModal2" data-whatever="" href="">click here</a> to reset your password.</p>
						</div>
						<div class="col-md-4">
					...
					<p>College profile login & signup? <a class="color-green" href="{{ URL::to('/educational-institution') }}" target="_blank">click here</a></p>
				{!! Form::close() !!}				
			</div>
		</div><!--/row-->
	</div>
...
<div class="modal fade" id="forgetPasswordModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog modalMain" role="document">
    <div class="modal-content modalbdymain">
    {!! Form::open(['url' => '/forget-password', 'method' => 'POST', 'data-parsley-validate' => '']) !!}
...
<script type="text/javascript">
	$('#forgetPasswordModal2').on('show.bs.modal', function (event) {
