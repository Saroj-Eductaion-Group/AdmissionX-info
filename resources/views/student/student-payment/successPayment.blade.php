	...
	<div class="container cooming-soon-content valign__middle">
		...
		<div class="row">
			<div class="col-md-12 coming-soon">
				...
				<h2 class="test-info">{{ Session::get('paymentSuccessMessage') }} <br><span class="color-red">AdmissionX</span></h2><br>
				<h3 class="test-info1">Please check your application status in your profile</h3><br>
				@endif

				@if(Session::has('paymentFailureMessage'))
				<h2 class="test-info">{{ Session::get('paymentFailureMessage') }} <br><span class="color-red">AdmissionX</span></h2><br>
				<h3 class="test-info1">Please check your application status in your profile</h3><br>
				@endif
				<a href="{{ URL::to('/login') }}" class="btn-u" title="Take me to login">Take me to my profile</a><br>
