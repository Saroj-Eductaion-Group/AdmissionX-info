<div class="profile-edit tab-pane fade in active margin-top30 white-popup">
	<div class="detail-page-signup">
		...
		<hr>
		<form method="POST" action="/student-project-desc-update" data-parsley-validate>
			<input type="hidden" name="documentId" value="{{ $documentId }}">
			<input type="hidden" name="slugUrl" value="{{ $slugUrl }}">
			<div class="row padding-top5 padding-bottom5">
		    	<div class="col-md-12">
		            <textarea class="form-control" name="description" rows="8" maxlength="1000" data-parsley-error-message = "Please enter the  description not more than 1000 characters" data-parsley-trigger="change" id="counttextarea">{{ $description }}</textarea>
