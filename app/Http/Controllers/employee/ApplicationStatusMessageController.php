...
class ApplicationStatusMessageController extends Controller
{
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $applicationstatusmessage = ApplicationStatusMessage::orderBy('id', 'DESC')
                    ...
                    return view('employee/applicationstatusmessage.index', compact('applicationstatusmessage'))
    ...
    public function create()
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                return view('employee/applicationstatusmessage.create');
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
            }
    ...
    public function store(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            return redirect('employee/applicationstatusmessage');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $applicationstatusmessage = ApplicationStatusMessage::orderBy('id', 'DESC')
                       ->leftJoin('application', 'applicationstatusmessages.application_id','=', 'application.id')
                        ...
                        ->findOrFail($id)
                        ;
            return view('employee/applicationstatusmessage.show', compact('applicationstatusmessage'));
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
            }
    ...
    public function edit($id)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                return view('employee/applicationstatusmessage.edit', compact('applicationstatusmessage'));
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
            }
    ...
    public function destroy($id)
    {
     ...
     public function applicationRemarkEmployeeSearch(Request $request)
    {
    ...
    public function allApplicationStatusEmployeeSearch(Request $request){
