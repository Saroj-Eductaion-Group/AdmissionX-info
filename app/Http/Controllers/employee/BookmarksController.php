            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    $bookmarks = Bookmark::orderBy('id', 'DESC')
                                ...
                                ->paginate(15, array('bookmarks.id', 'u1.id as userId1','u1.firstname as u1firstname', 'u1.lastname as u1lastname', 'ur1.name as ur1UserRoleName', 'u2.id as userId2','u2.firstname as u2firstname', 'u2.lastname as u2lastname', 'ur2.name as url2UserRoleName','course.name as courseName','blogs.id as blogsID','blogs.topic','collegeprofile.id as collegeprofileId','studentprofile.id as studentprofileId','collegemaster.id as collegemasterID','eID.id as eUserId','eID.firstname as employeeFirstname', 'eID.middlename as employeeMiddlename', 'eID.lastname as employeeLastname','bookmarks.updated_at'))
                            ;

                //$bookmarks = Bookmark::paginate(15);
                return view('employee/bookmarks.index', compact('bookmarks'))
                ...
                if( $validateUrlUsers >= '1' ){
                   ...
                   // $studentProfile = StudentProfile::all();
                    ...
                    $usersObj = DB::table('users')
                            ...
                            ->get()
                            ;
                    return view('employee/bookmarks.create')
                    ->with('blog',$blog)
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){        
                ...
                return redirect('employee/bookmarks');
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    $bookmark = Bookmark::orderBy('id', 'DESC')
                        ...
                        ->findOrFail($id)
                        ;
                    return view('employee/bookmarks.show', compact('bookmark'))
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                   ...
                   $usersObj = DB::table('users')
                    ...
                    return view('employee/bookmarks.edit', compact('bookmark'))
                    ->with('blog',$blog)
                    ->with('usersObj',$usersObj)
                    ->with('course',$course);
                }else{
