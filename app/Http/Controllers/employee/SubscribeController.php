...
class SubscribeController extends Controller
{
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    return view('employee/subscribe.index', compact('subscribe'))
    ...
    {   
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    return view('employee/subscribe.create');
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
                }
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                return redirect('employee/subscribe');
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    $subscribe = Subscribe::orderBy('id', 'DESC')
                        ...
                        ->findOrFail($id);
                    return view('employee/subscribe.show', compact('subscribe'));
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
                }
    ...
    {   
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    $subscribe = Subscribe::findOrFail($id);
                    return view('employee/subscribe.edit', compact('subscribe'));
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
                }
     ...
     * @return Response
     */
    public function subscribeEmployeeSearch(Request $request)
    {
    ...
    public function allSubscribeEmployeeSearch(Request $request){
    ...
    public function deleteEmployeeSearchSubscribe(Request $request, $id)
    {   
        Subscribe::destroy($id);
