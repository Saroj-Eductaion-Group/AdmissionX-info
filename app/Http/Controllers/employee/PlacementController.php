...
class PlacementController extends Controller
{
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
               ...
               $placement = Placement::orderBy('id', 'DESC')
                ...
                return view('employee/placement.index', compact('placement'))
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                $collegeProfileObj = DB::table('collegeprofile')
                            ...
                            ->get()
                            ;
                return view('employee/placement.create')
                ->with('collegeProfileObj', $collegeProfileObj);
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
    ...
    public function store(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
           // Placement::create($request->all());
            ...
            return redirect('employee/placement');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                return view('employee/placement.show', compact('placement'));
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
            }   
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $collegeProfileObj = DB::table('collegeprofile')
                                    ...
                                    ->get()
                                    ;
                return view('employee/placement.edit', compact('placement'))
                ->with('collegeProfileObj', $collegeProfileObj);
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
     ...
     * @return Response
     */
    public function placementEmployeeSearch(Request $request)
    {
    ...
    public function allPlacementEmployeeSearch(Request $request){
    ...
    public function deleteEmployeeSearchPlacemant(Request $request, $id)
    {   
        Placement::destroy($id);
