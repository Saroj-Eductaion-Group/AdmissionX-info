...
class UniversityController extends Controller
{
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                   ...
                   // $university = University::orderBy('id','DESC')->paginate(15);
                    ...
                    return view('administrator/university.index', compact('university','tablename'))->with('storeEditUpdateAction', $storeEditUpdateAction);
                }else{
    ...
    public function create()
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    $tablename = 'university';
                    return view('employee/university.create', compact('tablename'));
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
                }
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    return view('employee/university.show', compact('university','seocontent','newUpdatedFields','tablename'));
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
                }
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    return view('employee/university.edit', compact('university','seocontent','newUpdatedFields','tablename'));
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
                }
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( !empty(Input::get('name')) ){
                    ...
                    if( $universityNameCheck == '0' ){
                        ...
                        Session::flash('universityName', 'Duplicate university name found, kindly use another university name'); 
                        return redirect('employee/university/'.$id.'/edit');
                    }
                }
     ...
     * @return Response
     */
    public function universityEmployeeSearch(Request $request)
    {
    ...
    public function allUniversityEmployeeSearch(Request $request){
    ...
    public function deleteEmployeeSearchUniversity(Request $request, $id)
    {   
        University::destroy($id);
