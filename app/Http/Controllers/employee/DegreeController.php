...
class DegreeController extends Controller
{
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    $functionalAreaObj = FunctionalArea::all();
                    $tablename = 'degree';
                    return view('employee/degree.create', compact('tablename'))
                    ->with('functionalAreaObj',$functionalAreaObj);
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){    
                ...
                return redirect('employee/degree');
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    return view('employee/degree.show', compact('degree','seocontent','newUpdatedFields','tablename'));
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
                }
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    $newUpdatedFields = $this->fetchDataServiceController->fetchNewUpdatedFields('Degree','degree',$id);
                    $tablename = 'degree';
                    return view('employee/degree.edit', compact('degree','seocontent','newUpdatedFields','tablename'))
                    ->with('functionalAreaObj',$functionalAreaObj);
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
     ...
     * @return Response
     */
    public function degreeEmployeeSearch(Request $request)
    {
        $search0 = 'degree.id';
    ...
    public function allDegreeEmployeeSearch(Request $request){
    ...
    public function deleteEmployeeSearchDegree(Request $request, $id)
    {   
        Degree::destroy($id);
