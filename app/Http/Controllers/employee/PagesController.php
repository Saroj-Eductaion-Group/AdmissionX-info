...
class PagesController extends Controller
{
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $pages = Page::orderBy('id', 'DESC')
                            ...
                            ;
                return view('employee/pages.index', compact('pages'))
            ...
            if( $validateUrlUsers >= '1' ){
               // $page = Page::findOrFail($id);
                $page = Page::orderBy('id', 'DESC')
                        ...
                        ->findOrFail($id);
                return view('employee/pages.show', compact('page'));
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
            }
    ...
    public function edit($id)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                $page = Page::findOrFail($id);
                return view('employee/pages.edit', compact('page'));
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
            }
     ...
     * @return Response
     */
    public function pagesEmployeeSearch(Request $request)
    {
        $search0 = 'pages.id';
    ...
    public function allPagesEmployeeSearch(Request $request){
    ...
    public function deleteEmployeeSearchPages(Request $request, $id)
    {   
        Page::destroy($id);
