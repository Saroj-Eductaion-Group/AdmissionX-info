...
class InviteController extends Controller
{
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $usersObj = DB::table('users')
                            ...
                            ->get()
                            ;
                return view('employee/invite.index', compact('invite'))
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                $usersObj = DB::table('users')
                        ...
                        ->get()
                        ;
                return view('employee/invite.create')
                        ->with('usersObj', $usersObj)
                        ;
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
    ...
    public function store(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            return redirect('employee/invite');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                return view('employee/invite.show', compact('invite'));
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
            }
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $usersObj = DB::table('users')
                            ...
                            ->get()
                            ; 
                return view('employee/invite.edit', compact('invite'))
                            ->with('usersObj', $usersObj)
                            ;
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
    ...
    public function inviteEmployeeSearch(Request $request)
    {
        $search0 = 'invite.id';
    ...
    public function allInviteEmployeeSearch(Request $request){
    ...
    public function deleteEmployeeSearchInvite(Request $request, $id)
    {   
        Invite::destroy($id);
