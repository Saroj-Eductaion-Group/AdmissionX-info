...
class GalleryController extends Controller
{
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $gallery = Gallery::orderBy('id', 'DESC')
                        ...
                        ->Paginate(20, array('gallery.id', 'gallery.name as galleryName','caption','width','height', 'category.name as categoryName','users.id as userID','users.firstname', 'users.lastname', 'userrole.name as userRoleName','gallery.misc', 'eID.middlename as employeeMiddlename', 'eID.lastname as employeeLastname','eID.id as eUserId','eID.firstname as employeeFirstname', 'eID.middlename as employeeMiddlename', 'eID.lastname as employeeLastname','gallery.updated_at'));
                ...
                return View::make('employee/gallery.index')
    ...
    public function create()
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                return view('employee/gallery.create')
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            {   
                ...
                /*if( $ext != 'png' || $ext != 'jpg' || $ext != 'jpeg' ){
                    ...
                    return redirect('employee/galleries');
                    die;
                }
                */
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                return view('employee/gallery.show', compact('gallery'));*/
                 $gallery = DB::table('gallery')
                            ...
                            ->where('gallery.misc', '!=', 'collegeyoutubeurl')
                            ->where('gallery.misc', '!=', 'studentyoutubeurl')
                            ->select('gallery.id', 'gallery.name as galleryName', 'caption','width','height','category.name as categoryName','users.id as userID','users.firstname', 'users.lastname', 'userrole.name as userRoleName','gallery.misc','eID.id as eUserId','eID.firstname as employeeFirstname', 'eID.middlename as employeeMiddlename', 'eID.lastname as employeeLastname','eID.id as eUserId','eID.firstname as employeeFirstname', 'eID.middlename as employeeMiddlename', 'eID.lastname as employeeLastname','gallery.updated_at')
                             ->orderBy('gallery.id', 'DESC')
                            ->get();
                    
                return View::make('employee/gallery.show')
                 ->with('gallery', $gallery);
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $gallery = Gallery::orderBy('gallery.id' ,'DESC')
                    ...
                    return view('employee/gallery.edit', compact('gallery'))
                    ->with('userObj', $userObj)
                    ->with('categoryObj', $categoryObj)
                    ;
            }else{
     ...
     * @return Response
     */
    public function galleryEmployeeSearch(Request $request)
    {
        $search0 = 'gallery.id';
        ...
        $gallerySearchDataObj = DB::select( DB::raw("SELECT gallery.id as galleryID, gallery.name as galleryName,gallery.fullimage as galleryFullimage, gallery.users_id,category.name as categoryName,users.id as userID,users.firstname, users.lastname, userrole.name as userRoleName, gallery.caption as galleryCaption,gallery.misc FROM  `gallery`
    ...
    public function allGalleryEmployeeSearch(Request $request){
    ...
    public function youtubeLink(Request $request)
    {
        ...
        return view('employee/gallery.youtubelink')
    ...
    public function updateYoutubeLink(Request $request)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                return redirect('employee/youtube');
            }else{
                    Auth::logout(); // logout user
                    return Redirect::to('login'); //redirect back to login
            }
    ...
    public function deleteEmployeeSearchGallery(Request $request, $id)
    {   
        Gallery::destroy($id);
