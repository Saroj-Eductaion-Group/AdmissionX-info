...
class CityController extends Controller
{
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    return view('employee/city.create', compact('tablename'))
                    ->with('stateObj', $stateObj)
                    ->with('countryObj', $countryObj);
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    $tablename = 'city';
                    return view('employee/city.show', compact('city','seocontent','newUpdatedFields','tablename'));
                }else{
                    Session::flash('access_restricted_msg', 'Access Restricted!');
                    return Redirect::action('employee\AdminEmployeeController@index');
                }
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
                ...
                if( $validateUrlUsers >= '1' ){
                    ...
                    return view('employee/city.edit', compact('city','seocontent','newUpdatedFields','tablename')) 
                    ->with('stateObj', $stateObj)
                    ->with('countryObj', $countryObj)
    ...
    public function cityEmployeeSearch(Request $request)
    {
        $search0 = 'city.id';
    ...
    public function allCityEmployeeSearch(Request $request){
