...
class UsergroupController extends Controller
{
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
               ...
               $usergroup = UserGroup::orderBy('usergroups.id', 'DESC')
                ...
                return view('employee/usergroup.index', compact('usergroup'))
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
              //$allTableInfoObj = AllTableInformation::all();
                ...
                return view('employee/usergroup.create')
    ...
    public function store(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $checkSlugObj == '0' ){
                ...
                return redirect('employee/usergroup/create');
            }

            // return redirect()->action('UsergroupController@userGroupTableInfo', [$slugName]);
            if(env('APP_ENV') == 'local'){
               $dirUrl = url().'/employee/usergroup-table-info/'.$slugName;
            }else{
                $dirUrl = url().'/employee/usergroup-table-info/'.$slugName;
            }
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                return view('employee/usergroup.show', compact('usergroup'));
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
                return Redirect::action('employee\AdminEmployeeController@index');
            }
            ...
            if( $validateUrlUsers >= '1' ){
               ...
               // $allTableInfoObj = AllTableInformation::all();
                $allTableInfoObj = DB::table('alltableinformations')
                        ...
                        ->get()
                        ;
                return view('employee/usergroup.edit', compact('usergroup'))
                ->with('allTableInfoObj', $allTableInfoObj)
                ;
            }else{
                Session::flash('access_restricted_msg', 'Access Restricted!');
    ...
    public function update($id, Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            return redirect('employee/usergroup');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
        ...
        if( $roleGrant->userrole_id == '4' && $roleGrant->userstatus_id == '1' ){
            ...
            if( $validateUrlUsers >= '1' ){
                ...
                $allTableInfoObj = DB::table('alltableinformations')
                        ...
                        ->get()
                        ;
                return view('employee/usergroup.tableShowUpdate')
            ...
            if( $roleGrant->userrole_id == '4' && ($roleGrant['userstatus_id'] == '1') ){
                ...
                if($request->ajax())
                {
                    $getTableInfoData = UserGroup::where('usergroups.id', '=', $tableInfoId)
                                    ...
                                    ->firstOrFail()
                                    ;
                    return view('employee/usergroup.tableInfoUpdate')
