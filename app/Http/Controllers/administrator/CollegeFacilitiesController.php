...
class CollegeFacilitiesController extends Controller
{
    ...
    public function index()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/collegefacilities.index', compact('collegefacilities'))
    ...
    public function create()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            $collegeProfileObj = DB::table('users')
                        ...
                        ; 
            $facilitiesObj = Facility::all();
            return view('administrator/collegefacilities.create')
            ->with('collegeProfileObj',$collegeProfileObj)
            ->with('facilitiesObj',$facilitiesObj);
        }else{
                Auth::logout(); // logout user
    ...
    public function store(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return redirect('administrator/collegefacilities');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/collegefacilities.show', compact('collegefacility'));
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function edit($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            $facilitiesObj = Facility::all();
            return view('administrator/collegefacilities.edit', compact('collegefacility'))
                ->with('collegeProfileObj',$collegeProfileObj)
                ->with('facilitiesObj',$facilitiesObj)
     ...
     * @return Response
     */
    public function collegeFacilitySearch(Request $request)
    {
        ...
        $collegeFacilitySearchDataObj = DB::select( DB::raw("SELECT collegefacilities.id as collegefacilitiesId, collegefacilities.name as collegeFacilitiesName, collegefacilities.description as collegefacilitiesDesciption,collegeprofile.id as collegeprofileID, users.id as userID, users.firstname, users.lastname, userrole.name as userRoleName,facilities.name as facilitiesName,eID.id as eUserId, eID.firstname as employeeFirstname, eID.middlename as employeeMiddlename, eID.lastname as employeeLastname, collegefacilities.updated_at FROM  `collegefacilities`
    ...
    public function deleteSearchFacility(Request $request, $id)
    {   
        CollegeFacility::destroy($id);
