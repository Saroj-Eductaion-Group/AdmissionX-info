...
class DocumentsController extends Controller
{
    ...
    public function index()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            $collegeProfileObj = DB::table('users')
                ...
                return View::make('administrator/documents.index')
    ...
    public function create()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            $userObj = User::all();
            return view('administrator/documents.create')
           ...
           // Document::create($request->all());
            ...
            {            
                ...
                /*if( $ext != 'png' || $ext != 'jpg' || $ext != 'jpeg' || $ext != 'pdf' ){
                    ...
                    return redirect('administrator/documents');
                    die;
                }*/
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return View::make('administrator/documents.show')
    ...
    public function edit($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            $categoryObj = Category::all();
            $userObj = User::all();
            return view('administrator/documents.edit', compact('document'))
            ->with('userObj', $userObj)
            ->with('categoryObj', $categoryObj);
        }else{
                Auth::logout(); // logout user
    ...
    public function documentSearch(Request $request)
    {
        ...
        $documentSearchDataObj = DB::select( DB::raw("SELECT documents.id as documentsID, documents.name as documentsName,documents.fullimage as documentsFullimage, documents.users_id,category.name as categoryName,users.id as userID,users.firstname, users.lastname, userrole.name as userRoleName,documents.description,documents.updated_at FROM  `documents`
    ...
    public function allDocumentSearch(Request $request){
        ...
        $documents = Document::orderBy('documents.id', 'DESC')
                        ...
                        ->leftjoin('userrole', 'users.userrole_id', '=', 'userrole.id')
                        ->where('users.userstatus_id','!=','5')
                        ->select('documents.id as documentsID', 'documents.name as documentsName', 'documents.users_id','category.name as categoryName','users.id as userID','users.firstname', 'users.lastname', 'userrole.name as userRoleName','documents.description','documents.updated_at')
                        ->take(20)
                        ->get();
    ...
    public function deleteSearchDocument(Request $request, $id)
    {   
        Document::destroy($id);
