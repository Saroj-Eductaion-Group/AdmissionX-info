...
class StudentProfileController extends Controller
{
    ...
    {   
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                return view('administrator/studentprofile.index', compact('studentprofile'))
    ...
    {   
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                return view('administrator/studentprofile.create')
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){   
                ...
                return redirect('administrator/studentprofile');
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                return view('administrator/studentprofile.show', compact('studentprofile','seocontent'))
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                $studentDataObj = DB::table('studentprofile')
                            ...
                            ->select('users.id as usersId','gallery.id as galleryId','gallery.name as galleryName', 'gallery.fullimage as galleryFullImage', 'studentprofile.slug')
            ...
            // print_r($studentDataObj);die;
                ...
                return view('administrator/studentprofile.edit', compact('studentprofile','seocontent'))
                ->with('userObj', $userObj)
                ->with('entranceExam', $entranceExam)
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){   
               ...
               // $studentMarksObj1 = StudentMark::where('studentmarks.studentprofile_id', '=', $id )->where('studentmarks.name', '=', '10th')->firstOrFail();
                ...
                if(!empty($studentMarksObj2)){
                    ...
                    $studentMarksObj2 = new StudentMark;
                    $studentMarksObj2->name = '11th';
                    $studentMarksObj2->marks = Input::get('eleventhmarks');  
                    $studentMarksObj2->percentage = Input::get('eleventhMarksPercentage'); 
                    $studentMarksObj2->studentMarkType = Input::get('eleventhMarkType');
                    $studentMarksObj2->category_id = '3';
               ...
               // $studentMarksObj3 = StudentMark::where('studentmarks.studentprofile_id', '=', $id )->where('studentmarks.name', '=', '12th')->firstOrFail();
                ...
                if(!empty($studentMarksObj3)){
                    ...
                    $studentMarksObj3 = new StudentMark;
                    $studentMarksObj3->name = '12th';
                    $studentMarksObj3->marks = Input::get('twelvemarks');
                    $studentMarksObj3->percentage = Input::get('twelveMarksPercentage');
                    $studentMarksObj3->studentMarkType = Input::get('twelveMarkType');   
                    $studentMarksObj3->category_id = '3';
                    $studentMarksObj3->studentprofile_id = $id; 
                    $studentMarksObj3->employee_id = Auth::id();
                    $studentMarksObj3->save();
                }
    ...
    public function destroy($id)
    {
     ...
     public function getStudentDOBCalculate( Request $request )
    {
        $dateofbirth = Input::get('dateofbirth');
     ...
     * @return Response
     */
    public function studentProfileSearch(Request $request)
    {
...
//print_r($studentProfileDataObj1);die;
    ...
    public function allStudentProfileSearch(Request $request){
