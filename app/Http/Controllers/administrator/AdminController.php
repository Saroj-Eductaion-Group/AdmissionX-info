    ...
    public function index(Request $request)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                /***Send SMS *******************************/
                // $smsMessageData = Config::get('systemsetting.SIGNUPMSG').' '.$roleGrant->email.' '.Config::get('systemsetting.SMS_GROUP_NAME_5');
                // $resultSet = $this->fetchDataServiceController->sendTextSmsOnMobile($roleGrant->phone, $smsMessageData, Config::get('systemsetting.TEMPLATE_SIGN_OTP'));
