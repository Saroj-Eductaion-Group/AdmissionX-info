...
class LogsController extends Controller
{
    ...
    {   
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/logs.index', compact('logs'))
    ...
    public function create()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            $usersObj = DB::table('users')
                        ...
                        ->get()
                        ;
            return view('administrator/logs.create')
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/logs.show', compact('log'));
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function edit($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            $usersObj = DB::table('users')
                        ...
                        ->get()
                        ;            
            return view('administrator/logs.edit', compact('log'))
                        ->with('usersObj', $usersObj)
                        ;
        }else{
                Auth::logout(); // logout user
    ...
    public function allLogSearch(Request $request){
    ...
    public function deleteSearchLogs(Request $request, $id)
    {   
        Log::destroy($id);
    ...
    public function WebsiteAnalytics(Request $request)
    {
        ...
        return view('administrator/logs.website-analytics')
