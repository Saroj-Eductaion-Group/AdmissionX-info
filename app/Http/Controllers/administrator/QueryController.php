...
class QueryController extends Controller
{
    ...
    public function index()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            $query = Query::orderBy('query.id', 'ASC')
                        ...
                        ->paginate(20, array('query.id', 'query.subject', 'query.queryflowtype', 'query.chatkey','query.message','U1.id as U1Id','U1.firstname as U1FirstName', 'U1.lastname as U1LastName', 'U2.id as U2Id','U2.firstname as U2FirstName', 'U2.lastname as U2LastName', 'U3.id as U3Id','U3.firstname as U3FirstName', 'U3.middlename as U3MiddleName','U3.lastname as U3LastName','collegeprofile.id as collegeprofileID','studentprofile.id as studentprofileID','eID.id as eUserId','eID.firstname as employeeFirstname', 'eID.middlename as employeeMiddlename', 'eID.lastname as employeeLastname','query.updated_at'))
                        ;
            ...
            return view('administrator/query.index', compact('query'))
    ...
    public function create()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/query.create')
    ...
    public function store(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return redirect('administrator/query');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/query.show', compact('query'));
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function edit($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/query.edit', compact('query'))
                    ->with('usersObj', $usersObj)
    ...
    public function allQuerySearch(Request $request){
    ...
    public function deleteSearchQuery(Request $request, $id)
    {   
        Query::destroy($id);
    ...
    public function queryToBya(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/query.bya-index', compact('query'))
            ->with('userObj',$userObj);
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
    ...
    public function queryToByaDetails(Request $request, $id, $person)
    {
        ...
        $query = DB::table('query')
                            ...
                            ->get()
                            ;
        $guestToAdmin = $query[0]->queryflowtype;
        ...
        return view('administrator/query.bya-index-details', compact('query'))
            ->with('queryInfo',$queryInfo)
            ->with('userObj',$userObj)
            ->with('queryID', $id)
            ->with('person', $person)
            ->with('guestToAdmin', $guestToAdmin)
            ;
    }
    ...
    public function queryBetweenCollegeStudent(Request $request)
    {
        ...
        return view('administrator/query.college-between-student-index')
    ...
    {   
        ...
        return view('administrator/query.college-between-student-details')
                ->with('query', $query)
                ->with('queryInfo', $queryInfo)
                ;
    }
    ...
    {   
        ...
        return view('administrator/query.query-details')
                ->with('query', $query)
                ->with('queryInfo', $queryInfo)
                ;
    }
     ...
     * @return Response
     */
    public function querySearchAdmissionx(Request $request)
    {
        $search0 = 'query.id';
    ...
    public function allQuerySearchAdmissionx(Request $request){
