...
class AllTableInformationController extends Controller
{
    ...
    public function index()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
           $alltableinformation = allTableInformation::paginate(15);
            return view('administrator/alltableinformation.index', compact('alltableinformation'));
        }else{
    ...
    public function create()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            return view('administrator/alltableinformation.create');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function store(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            $allTableInformation = New allTableInformation();
            ...
            return redirect('administrator/alltableinformation');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/alltableinformation.show', compact('alltableinformation'));
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function edit($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            $alltableinformation = allTableInformation::findOrFail($id);
            return view('administrator/alltableinformation.edit', compact('alltableinformation'));
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
