...
class AddressController extends Controller
{
    ...
    public function index()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/address.index', compact('address'))
    ...
    public function create()
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            $stateNameObj = DB::table('state')
                    ...
                    ;
            $addressTypeObj = AddressType::all();
            return view('administrator/address.create')
            ->with('collegeProfileObj', $collegeProfileObj)
    ...
    public function store(Request $request)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return redirect('administrator/address');
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/address.show', compact('address'));
        }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function edit($id)
    {
        ...
        if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
            ...
            return view('administrator/address.edit', compact('address'))
            ->with('collegeProfileObj', $collegeProfileObj)
            ->with('studentProfile', $studentProfile)
            ->with('cityNameObj', $cityNameObj)
            ->with('addressTypeObj', $addressTypeObj)
    ...
    public function getAllStateNameData( Request $request )
    {
        $countryId = Input::get('countryId');

        $stateObj = DB::table('country')
                    ->join('state', function ($join) use ($countryId) {
                                   $join->on('country.id', '=', 'state.country_id')
                                        ->where('country.id', '=', DB::raw($countryId));
                                   })
        ...
        if( !empty($countryId) ){
            $dataArray = array( 'code' => '200' , 'stateData' => $stateObj );
        }else{
            $dataArray = array( 'code' => '401' , 'stateData' => '' );
        }
    ...
    public function allAddressSearch(Request $request){
