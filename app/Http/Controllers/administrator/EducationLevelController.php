...
class EducationLevelController extends Controller
{
    ...
    public function create()
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                $tablename = 'educationlevel';
                return view('administrator/educationlevel.create', compact('tablename'));
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
               // EducationLevel::create($request->all());
                ...
                return redirect('administrator/educationlevel');
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                return view('administrator/educationlevel.show', compact('educationlevel','seocontent','newUpdatedFields','tablename'));
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function edit($id)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                $newUpdatedFields = $this->fetchDataServiceController->fetchNewUpdatedFields('EducationLevel','educationlevel',$id);
                $tablename = 'educationlevel';
                return view('administrator/educationlevel.edit', compact('educationlevel','seocontent','newUpdatedFields','tablename'));
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function educationLevelSearch(Request $request)
    {
    ...
    public function allEducationLevelSearch(Request $request){
    ...
    public function deleteSearchEducationLavel(Request $request, $id)
    {   
        EducationLevel::destroy($id);
