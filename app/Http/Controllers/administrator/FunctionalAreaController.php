...
class FunctionalAreaController extends Controller
{
    ...
    public function create()
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                $tablename = 'functionalarea';
                return view('administrator/functionalarea.create', compact('tablename'));
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){    
                ...
                return redirect('administrator/functionalarea');
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function show($id)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                return view('administrator/functionalarea.show', compact('functionalarea','seocontent','newUpdatedFields','tablename'));
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
    ...
    public function edit($id)
    {
        ...
        if (Auth::check())
        {
            ...
            if( $roleGrant->userrole_id == '1' && $roleGrant->userstatus_id == '1' ){
                ...
                return view('administrator/functionalarea.edit', compact('functionalarea','seocontent','newUpdatedFields','tablename'));
            }else{
                Auth::logout(); // logout user
                return Redirect::to('login'); //redirect back to login
            }
     ...
     * @return Response
     */
    public function functionalAreaSearch(Request $request)
    {
    ...
    public function allFunctionalAreaSearch(Request $request){
    ...
    public function deleteEmployeeSearchFunctionalArea(Request $request, $id)
    {   
        FunctionalArea::destroy($id);
