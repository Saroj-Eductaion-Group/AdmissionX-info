...
class CreateCollegeMasterAssociateFacultiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('college_master_associate_faculties', function(Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('college_master_associate_faculties');
    }
}
